...
// CoreSynthCollection Graph Visualization Extension
class CoreSynthCollectionGraph : public PluginSDK::GraphVisualization {
public:
	CoreSynthCollectionGraph();
	virtual ~CoreSynthCollectionGraph();
...
public:
	...
	CoreSynthCollectionGraph& GetGraph() { return graph; }
	const CoreSynthCollectionGraph& GetGraph() const { return graph; }
...
private:
	...
	CoreSynthCollectionGraph graph;           // Graph visualization interface
