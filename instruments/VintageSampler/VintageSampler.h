...
// VintageSampler Graph Visualization Extension
class VintageSamplerGraph : public PluginSDK::GraphVisualization {
public:
	VintageSamplerGraph();
	virtual ~VintageSamplerGraph();
...
public:
	...
	VintageSamplerGraph& GetGraph() { return graph; }
	const VintageSamplerGraph& GetGraph() const { return graph; }
...
private:
	...
	VintageSamplerGraph graph;           // Graph visualization interface
