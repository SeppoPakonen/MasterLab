...
// MomentumLoopStation Graph Visualization Extension
class MomentumLoopStationGraph : public PluginSDK::GraphVisualization {
public:
	MomentumLoopStationGraph();
	virtual ~MomentumLoopStationGraph();
...
public:
	...
	MomentumLoopStationGraph& GetGraph() { return graph; }
	const MomentumLoopStationGraph& GetGraph() const { return graph; }
...
private:
	...
	MomentumLoopStationGraph graph;           // Graph visualization interface
