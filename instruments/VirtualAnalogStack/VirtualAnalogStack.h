...
// VirtualAnalogStack Graph Visualization Extension
class VirtualAnalogStackGraph : public PluginSDK::GraphVisualization {
public:
	VirtualAnalogStackGraph();
	virtual ~VirtualAnalogStackGraph();
...
public:
	...
	VirtualAnalogStackGraph& GetGraph() { return graph; }
	const VirtualAnalogStackGraph& GetGraph() const { return graph; }
...
private:
	...
	VirtualAnalogStackGraph graph;           // Graph visualization interface
