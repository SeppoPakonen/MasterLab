...
// LayeredRompler Graph Visualization Extension
class LayeredRomplerGraph : public PluginSDK::GraphVisualization {
public:
	LayeredRomplerGraph();
	virtual ~LayeredRomplerGraph();
...
public:
	...
	LayeredRomplerGraph& GetGraph() { return graph; }
	const LayeredRomplerGraph& GetGraph() const { return graph; }
...
private:
	...
	LayeredRomplerGraph graph;           // Graph visualization interface
