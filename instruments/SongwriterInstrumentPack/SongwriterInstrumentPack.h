...
// SongwriterInstrumentPack Graph Visualization Extension
class SongwriterInstrumentPackGraph : public PluginSDK::GraphVisualization {
public:
	SongwriterInstrumentPackGraph();
	virtual ~SongwriterInstrumentPackGraph();
...
public:
	...
	virtual ~SongwriterInstrumentPack();
	...
	SongwriterInstrumentPackGraph& GetGraph() { return graph; }
	const SongwriterInstrumentPackGraph& GetGraph() const { return graph; }
...
private:
	...
	SongwriterInstrumentPackGraph graph;           // Graph visualization interface
