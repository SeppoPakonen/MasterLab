#ifndef _midieffects_chordprogressionmapper_chordprogressionmapper_h_
#define _midieffects_chordprogressionmapper_chordprogressionmapper_h_
...
// ChordProgressionMapper Graph Visualization Extension
class ChordProgressionMapperGraph : public PluginSDK::GraphVisualization {
public:
	ChordProgressionMapperGraph();
	virtual ~ChordProgressionMapperGraph();
...
public:
	...
	virtual ~ChordProgressionMapper();
	...
	ChordProgressionMapperGraph& GetGraph() { return graph; }
	const ChordProgressionMapperGraph& GetGraph() const { return graph; }
...
private:
	...
	ChordProgressionMapperGraph graph;           // Graph visualization interface
