#ifndef _midieffects_groovehumanizer_groovehumanizer_h_
#define _midieffects_groovehumanizer_groovehumanizer_h_
...
// GrooveHumanizer Graph Visualization Extension
class GrooveHumanizerGraph : public PluginSDK::GraphVisualization {
public:
	GrooveHumanizerGraph();
	virtual ~GrooveHumanizerGraph();
...
public:
	...
	GrooveHumanizerGraph& GetGraph() { return graph; }
	const GrooveHumanizerGraph& GetGraph() const { return graph; }
...
private:
	...
	GrooveHumanizerGraph graph;           // Graph visualization interface
