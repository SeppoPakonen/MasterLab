...
// ZenCoreFxRack Graph Visualization Extension
class ZenCoreFxRackGraph : public PluginSDK::GraphVisualization {
public:
	ZenCoreFxRackGraph();
	virtual ~ZenCoreFxRackGraph();
...
public:
	...
	ZenCoreFxRackGraph& GetGraph() { return graph; }
	const ZenCoreFxRackGraph& GetGraph() const { return graph; }
...
private:
	...
	ZenCoreFxRackGraph graph;           // Graph visualization interface
