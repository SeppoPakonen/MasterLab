...
// DynamicsControlSuite Graph Visualization Extension
class DynamicsControlSuiteGraph : public PluginSDK::GraphVisualization {
public:
	DynamicsControlSuiteGraph();
	virtual ~DynamicsControlSuiteGraph();
...
public:
	...
	DynamicsControlSuiteGraph& GetGraph() { return graph; }
	const DynamicsControlSuiteGraph& GetGraph() const { return graph; }
...
private:
	...
	DynamicsControlSuiteGraph graph;           // Graph visualization interface
