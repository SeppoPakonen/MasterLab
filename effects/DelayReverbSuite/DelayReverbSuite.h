...
// DelayReverbSuite Graph Visualization Extension
class DelayReverbSuiteGraph : public PluginSDK::GraphVisualization {
public:
	DelayReverbSuiteGraph();
	virtual ~DelayReverbSuiteGraph();
...
public:
	...
	DelayReverbSuiteGraph& GetGraph() { return graph; }
	const DelayReverbSuiteGraph& GetGraph() const { return graph; }
...
private:
	...
	DelayReverbSuiteGraph graph;           // Graph visualization interface
