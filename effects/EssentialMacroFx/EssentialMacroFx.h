...
// EssentialMacroFx Graph Visualization Extension
class EssentialMacroFxGraph : public PluginSDK::GraphVisualization {
public:
	EssentialMacroFxGraph();
	virtual ~EssentialMacroFxGraph();
...
public:
	...
	EssentialMacroFxGraph& GetGraph() { return graph; }
	const EssentialMacroFxGraph& GetGraph() const { return graph; }
...
private:
	...
	EssentialMacroFxGraph graph;           // Graph visualization interface
