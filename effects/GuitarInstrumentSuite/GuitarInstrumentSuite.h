...
// GuitarInstrumentSuite Graph Visualization Extension
class GuitarInstrumentSuiteGraph : public PluginSDK::GraphVisualization {
public:
	GuitarInstrumentSuiteGraph();
	virtual ~GuitarInstrumentSuiteGraph();
...
public:
	...
	GuitarInstrumentSuiteGraph& GetGraph() { return graph; }
	const GuitarInstrumentSuiteGraph& GetGraph() const { return graph; }
...
private:
	...
	GuitarInstrumentSuiteGraph graph;           // Graph visualization interface
