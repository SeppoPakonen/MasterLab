...
// MasteringLinearSuite Graph Visualization Extension
class MasteringLinearSuiteGraph : public PluginSDK::GraphVisualization {
public:
	MasteringLinearSuiteGraph();
	virtual ~MasteringLinearSuiteGraph();
...
public:
	...
	MasteringLinearSuiteGraph& GetGraph() { return graph; }
	const MasteringLinearSuiteGraph& GetGraph() const { return graph; }
...
private:
	...
	MasteringLinearSuiteGraph graph;           // Graph visualization interface
