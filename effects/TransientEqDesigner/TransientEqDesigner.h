...
// TransientEqDesigner Graph Visualization Extension
class TransientEqDesignerGraph : public PluginSDK::GraphVisualization {
public:
	TransientEqDesignerGraph();
	virtual ~TransientEqDesignerGraph();
...
public:
	...
	TransientEqDesignerGraph& GetGraph() { return graph; }
	const TransientEqDesignerGraph& GetGraph() const { return graph; }
...
private:
	...
	TransientEqDesignerGraph graph;           // Graph visualization interface
