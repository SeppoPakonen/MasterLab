...
// AiAssistSuite Graph Visualization Extension
class AiAssistSuiteGraph : public PluginSDK::GraphVisualization {
public:
	AiAssistSuiteGraph();
	virtual ~AiAssistSuiteGraph();
...
public:
	...
	AiAssistSuiteGraph& GetGraph() { return graph; }
	const AiAssistSuiteGraph& GetGraph() const { return graph; }
...
private:
	...
	AiAssistSuiteGraph graph;           // Graph visualization interface
