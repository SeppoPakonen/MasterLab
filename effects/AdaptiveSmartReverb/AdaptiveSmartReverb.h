...
// AdaptiveSmartReverb Graph Visualization Extension
class AdaptiveSmartReverbGraph : public PluginSDK::GraphVisualization {
public:
	AdaptiveSmartReverbGraph();
	virtual ~AdaptiveSmartReverbGraph();
...
public:
	...
	AdaptiveSmartReverbGraph& GetGraph() { return graph; }
	const AdaptiveSmartReverbGraph& GetGraph() const { return graph; }
...
private:
	...
	AdaptiveSmartReverbGraph graph;           // Graph visualization interface
