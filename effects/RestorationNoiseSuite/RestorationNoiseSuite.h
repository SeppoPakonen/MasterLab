#ifndef _effects_restorationnoisesuite_restorationnoisesuite_h_
#define _effects_restorationnoisesuite_restorationnoisesuite_h_
...
// RestorationNoiseSuite Graph Visualization Extension
class RestorationNoiseSuiteGraph : public PluginSDK::GraphVisualization {
public:
	RestorationNoiseSuiteGraph();
	virtual ~RestorationNoiseSuiteGraph();
...
class RestorationNoiseSuite : public PluginSDK::PluginProcessor {
public:
	typedef RestorationNoiseSuite CLASSNAME;
	RestorationNoiseSuite();
	virtual ~RestorationNoiseSuite();
	...
	RestorationNoiseSuiteGraph& GetGraph() { return graph; }
	const RestorationNoiseSuiteGraph& GetGraph() const { return graph; }
...
private:
	...
	RestorationNoiseSuiteGraph graph;           // Graph visualization interface
