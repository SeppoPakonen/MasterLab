...
// TimelessDualDelay Graph Visualization Extension
class TimelessDualDelayGraph : public PluginSDK::GraphVisualization {
public:
	TimelessDualDelayGraph();
	virtual ~TimelessDualDelayGraph();
...
public:
	...
	TimelessDualDelayGraph& GetGraph() { return graph; }
	const TimelessDualDelayGraph& GetGraph() const { return graph; }
...
private:
	...
	TimelessDualDelayGraph graph;           // Graph visualization interface
