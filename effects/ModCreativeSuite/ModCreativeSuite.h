...
// ModCreativeSuite Graph Visualization Extension
class ModCreativeSuiteGraph : public PluginSDK::GraphVisualization {
public:
	ModCreativeSuiteGraph();
	virtual ~ModCreativeSuiteGraph();
...
public:
	...
	ModCreativeSuiteGraph& GetGraph() { return graph; }
	const ModCreativeSuiteGraph& GetGraph() const { return graph; }
...
private:
	...
	ModCreativeSuiteGraph graph;           // Graph visualization interface
