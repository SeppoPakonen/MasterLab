...
// GuitarInstrumentPlatforms Graph Visualization Extension
class GuitarInstrumentPlatformsGraph : public PluginSDK::GraphVisualization {
public:
	GuitarInstrumentPlatformsGraph();
	virtual ~GuitarInstrumentPlatformsGraph();
...
public:
	...
	virtual ~GuitarInstrumentPlatforms();
	...
	GuitarInstrumentPlatformsGraph& GetGraph() { return graph; }
	const GuitarInstrumentPlatformsGraph& GetGraph() const { return graph; }
...
private:
	...
	GuitarInstrumentPlatformsGraph graph;           // Graph visualization interface
