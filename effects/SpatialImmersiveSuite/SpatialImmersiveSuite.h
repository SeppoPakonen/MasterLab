...
// SpatialImmersiveSuite Graph Visualization Extension
class SpatialImmersiveSuiteGraph : public PluginSDK::GraphVisualization {
public:
	SpatialImmersiveSuiteGraph();
	virtual ~SpatialImmersiveSuiteGraph();
...
public:
	...
	SpatialImmersiveSuiteGraph& GetGraph() { return graph; }
	const SpatialImmersiveSuiteGraph& GetGraph() const { return graph; }
...
private:
	...
	SpatialImmersiveSuiteGraph graph;           // Graph visualization interface
