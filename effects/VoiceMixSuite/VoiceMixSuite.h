...
// VoiceMixSuite Graph Visualization Extension
class VoiceMixSuiteGraph : public PluginSDK::GraphVisualization {
public:
	VoiceMixSuiteGraph();
	virtual ~VoiceMixSuiteGraph();
...
public:
	...
	VoiceMixSuiteGraph& GetGraph() { return graph; }
	const VoiceMixSuiteGraph& GetGraph() const { return graph; }
...
private:
	...
	VoiceMixSuiteGraph graph;           // Graph visualization interface
