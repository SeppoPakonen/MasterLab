...
HarmonicAmpSuiteGraph::HarmonicAmpSuiteGraph() {
...
void HarmonicAmpSuiteGraph::InitializeGraph() {
...
void HarmonicAmpSuiteGraph::UpdateGraph() {
	// Update graph based on current parameter state
	// This allows visualization to react to parameter changes
}

const UI::GraphVisualizationCtrl& HarmonicAmpSuiteGraph::GetVisualizationCtrl() const {
	return viz_ctrl;
}
...
void HarmonicAmpSuite::InitializeGraph() {
...
void HarmonicAmpSuite::ProcessGraph(PluginSDK::ProcessContext& ctx) {
...
void HarmonicAmpSuite::ProcessNode(const GraphNode& node, PluginSDK::ProcessContext& ctx) {
...
void HarmonicAmpSuite::SetParameter(int index, double value) {
	if (index >= 0 && index < parameters.GetCount()) {
...
void HarmonicAmpSuite::UpdateParameter(int index, double value) {
...
String HarmonicAmpSuite::GetParameterName(int index) const {
...
String HarmonicAmpSuite::GetParameterText(int index) const {
...
void HarmonicAmpSuite::UpdateVisualization() {
	// Update the visualization to reflect current state
	// This sends current graph state to the UI visualization
}

void HarmonicAmpSuite::ProcessMidiEvents(const Upp::Vector<PluginSDK::MidiEvent>& events) {
...
void HarmonicAmpSuite::RouteMidiEvent(const PluginSDK::MidiEvent& evt) {
