...
// HarmonicAmpSuite Graph Visualization Extension
class HarmonicAmpSuiteGraph : public PluginSDK::GraphVisualization {
public:
	HarmonicAmpSuiteGraph();
	virtual ~HarmonicAmpSuiteGraph();
...
public:
	...
	HarmonicAmpSuiteGraph& GetGraph() { return graph; }
	const HarmonicAmpSuiteGraph& GetGraph() const { return graph; }
...
private:
	...
	HarmonicAmpSuiteGraph graph;           // Graph visualization interface
