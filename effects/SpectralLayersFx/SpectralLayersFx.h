...
// SpectralLayersFx Graph Visualization Extension
class SpectralLayersFxGraph : public PluginSDK::GraphVisualization {
public:
	SpectralLayersFxGraph();
	virtual ~SpectralLayersFxGraph();
...
public:
	...
	SpectralLayersFxGraph& GetGraph() { return graph; }
	const SpectralLayersFxGraph& GetGraph() const { return graph; }
...
private:
	...
	SpectralLayersFxGraph graph;           // Graph visualization interface
