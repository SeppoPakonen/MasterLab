...
// VocalDesignRack Graph Visualization Extension
class VocalDesignRackGraph : public PluginSDK::GraphVisualization {
public:
	VocalDesignRackGraph();
	virtual ~VocalDesignRackGraph();
...
public:
	...
	VocalDesignRackGraph& GetGraph() { return graph; }
	const VocalDesignRackGraph& GetGraph() const { return graph; }
...
private:
	...
	VocalDesignRackGraph graph;           // Graph visualization interface
