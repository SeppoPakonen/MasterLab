...
// ReverbAmbienceSuite Graph Visualization Extension
class ReverbAmbienceSuiteGraph : public PluginSDK::GraphVisualization {
public:
	ReverbAmbienceSuiteGraph();
	virtual ~ReverbAmbienceSuiteGraph();
...
public:
	...
	ReverbAmbienceSuiteGraph& GetGraph() { return graph; }
	const ReverbAmbienceSuiteGraph& GetGraph() const { return graph; }
...
private:
	...
	ReverbAmbienceSuiteGraph graph;           // Graph visualization interface
