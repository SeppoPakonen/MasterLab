...
// NeuralVoiceChanger Graph Visualization Extension
class NeuralVoiceChangerGraph : public PluginSDK::GraphVisualization {
public:
	NeuralVoiceChangerGraph();
	virtual ~NeuralVoiceChangerGraph();
...
public:
	...
	NeuralVoiceChangerGraph& GetGraph() { return graph; }
	const NeuralVoiceChangerGraph& GetGraph() const { return graph; }
...
private:
	...
	NeuralVoiceChangerGraph graph;           // Graph visualization interface
