...
// ReverbDelaySuite Graph Visualization Extension
class ReverbDelaySuiteGraph : public PluginSDK::GraphVisualization {
public:
	ReverbDelaySuiteGraph();
	virtual ~ReverbDelaySuiteGraph();
...
public:
	...
	ReverbDelaySuiteGraph& GetGraph() { return graph; }
	const ReverbDelaySuiteGraph& GetGraph() const { return graph; }
...
private:
	...
	ReverbDelaySuiteGraph graph;           // Graph visualization interface
