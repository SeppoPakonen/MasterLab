...
// HarmonicsDynamicsSuite Graph Visualization Extension
class HarmonicsDynamicsSuiteGraph : public PluginSDK::GraphVisualization {
public:
	HarmonicsDynamicsSuiteGraph();
	virtual ~HarmonicsDynamicsSuiteGraph();
...
public:
	...
	virtual ~HarmonicsDynamicsSuite();
	...
	HarmonicsDynamicsSuiteGraph& GetGraph() { return graph; }
	const HarmonicsDynamicsSuiteGraph& GetGraph() const { return graph; }
...
private:
	...
	HarmonicsDynamicsSuiteGraph graph;           // Graph visualization interface
