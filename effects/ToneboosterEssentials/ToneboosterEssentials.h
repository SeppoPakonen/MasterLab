...
// ToneboosterEssentials Graph Visualization Extension
class ToneboosterEssentialsGraph : public PluginSDK::GraphVisualization {
public:
	ToneboosterEssentialsGraph();
	virtual ~ToneboosterEssentialsGraph();
...
public:
	...
	ToneboosterEssentialsGraph& GetGraph() { return graph; }
	const ToneboosterEssentialsGraph& GetGraph() const { return graph; }
...
private:
	...
	ToneboosterEssentialsGraph graph;           // Graph visualization interface
