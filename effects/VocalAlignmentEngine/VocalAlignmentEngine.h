...
// VocalAlignmentEngine Graph Visualization Extension
class VocalAlignmentEngineGraph : public PluginSDK::GraphVisualization {
public:
	VocalAlignmentEngineGraph();
	virtual ~VocalAlignmentEngineGraph();
...
public:
	...
	VocalAlignmentEngineGraph& GetGraph() { return graph; }
	const VocalAlignmentEngineGraph& GetGraph() const { return graph; }
...
private:
	...
	VocalAlignmentEngineGraph graph;           // Graph visualization interface
