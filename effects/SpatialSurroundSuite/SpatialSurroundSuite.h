...
// SpatialSurroundSuite Graph Visualization Extension
class SpatialSurroundSuiteGraph : public PluginSDK::GraphVisualization {
public:
	SpatialSurroundSuiteGraph();
	virtual ~SpatialSurroundSuiteGraph();
...
public:
	...
	SpatialSurroundSuiteGraph& GetGraph() { return graph; }
	const SpatialSurroundSuiteGraph& GetGraph() const { return graph; }
...
private:
	...
	SpatialSurroundSuiteGraph graph;           // Graph visualization interface
