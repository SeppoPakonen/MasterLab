#ifndef _effects_signaturechainsuite_signaturechainsuite_h_
#define _effects_signaturechainsuite_signaturechainsuite_h_
...
// SignatureChainSuite Graph Visualization Extension
class SignatureChainSuiteGraph : public PluginSDK::GraphVisualization {
public:
	SignatureChainSuiteGraph();
	virtual ~SignatureChainSuiteGraph();
...
class SignatureChainSuite : public PluginSDK::PluginProcessor {
public:
	typedef SignatureChainSuite CLASSNAME;
	SignatureChainSuite();
	virtual ~SignatureChainSuite();
	...
	SignatureChainSuiteGraph& GetGraph() { return graph; }
	const SignatureChainSuiteGraph& GetGraph() const { return graph; }
...
private:
	...
	SignatureChainSuiteGraph graph;           // Graph visualization interface
