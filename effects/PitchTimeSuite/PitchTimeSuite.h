...
// PitchTimeSuite Graph Visualization Extension
class PitchTimeSuiteGraph : public PluginSDK::GraphVisualization {
public:
	PitchTimeSuiteGraph();
	virtual ~PitchTimeSuiteGraph();
...
public:
	...
	PitchTimeSuiteGraph& GetGraph() { return graph; }
	const PitchTimeSuiteGraph& GetGraph() const { return graph; }
...
private:
	...
	PitchTimeSuiteGraph graph;           // Graph visualization interface
