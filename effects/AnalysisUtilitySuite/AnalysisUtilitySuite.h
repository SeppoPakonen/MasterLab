...
// AnalysisUtilitySuite Graph Visualization Extension
class AnalysisUtilitySuiteGraph : public PluginSDK::GraphVisualization {
public:
	AnalysisUtilitySuiteGraph();
	virtual ~AnalysisUtilitySuiteGraph();
...
public:
	...
	AnalysisUtilitySuiteGraph& GetGraph() { return graph; }
	const AnalysisUtilitySuiteGraph& GetGraph() const { return graph; }
...
private:
	...
	AnalysisUtilitySuiteGraph graph;           // Graph visualization interface
