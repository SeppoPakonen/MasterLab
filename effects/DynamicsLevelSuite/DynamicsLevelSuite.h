...
// DynamicsLevelSuite Graph Visualization Extension
class DynamicsLevelSuiteGraph : public PluginSDK::GraphVisualization {
public:
	DynamicsLevelSuiteGraph();
	virtual ~DynamicsLevelSuiteGraph();
...
public:
	...
	DynamicsLevelSuiteGraph& GetGraph() { return graph; }
	const DynamicsLevelSuiteGraph& GetGraph() const { return graph; }
...
private:
	...
	DynamicsLevelSuiteGraph graph;           // Graph visualization interface
