#ifndef _effects_restorationnoisecollection_restorationnoisecollection_h_
#define _effects_restorationnoisecollection_restorationnoisecollection_h_
...
// RestorationNoiseCollection Graph Visualization Extension
class RestorationNoiseCollectionGraph : public PluginSDK::GraphVisualization {
public:
	RestorationNoiseCollectionGraph();
	virtual ~RestorationNoiseCollectionGraph();
...
class RestorationNoiseCollection : public PluginSDK::PluginProcessor {
public:
	typedef RestorationNoiseCollection CLASSNAME;
	RestorationNoiseCollection();
	virtual ~RestorationNoiseCollection();
	...
	RestorationNoiseCollectionGraph& GetGraph() { return graph; }
	const RestorationNoiseCollectionGraph& GetGraph() const { return graph; }
...
private:
	...
	RestorationNoiseCollectionGraph graph;           // Graph visualization interface
