...
// ModularGuitarRig Graph Visualization Extension
class ModularGuitarRigGraph : public PluginSDK::GraphVisualization {
public:
	ModularGuitarRigGraph();
	virtual ~ModularGuitarRigGraph();
...
public:
	...
	ModularGuitarRigGraph& GetGraph() { return graph; }
	const ModularGuitarRigGraph& GetGraph() const { return graph; }
...
private:
	...
	ModularGuitarRigGraph graph;           // Graph visualization interface
