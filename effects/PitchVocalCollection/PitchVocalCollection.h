...
// PitchVocalCollection Graph Visualization Extension
class PitchVocalCollectionGraph : public PluginSDK::GraphVisualization {
public:
	PitchVocalCollectionGraph();
	virtual ~PitchVocalCollectionGraph();
...
public:
	...
	PitchVocalCollectionGraph& GetGraph() { return graph; }
	const PitchVocalCollectionGraph& GetGraph() const { return graph; }
...
private:
	...
	PitchVocalCollectionGraph graph;           // Graph visualization interface
