...
// VocalLiveUtilities Graph Visualization Extension
class VocalLiveUtilitiesGraph : public PluginSDK::GraphVisualization {
public:
	VocalLiveUtilitiesGraph();
	virtual ~VocalLiveUtilitiesGraph();
...
public:
	...
	VocalLiveUtilitiesGraph& GetGraph() { return graph; }
	const VocalLiveUtilitiesGraph& GetGraph() const { return graph; }
...
private:
	...
	VocalLiveUtilitiesGraph graph;           // Graph visualization interface
