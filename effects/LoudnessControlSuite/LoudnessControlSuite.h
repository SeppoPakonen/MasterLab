...
// LoudnessControlSuite Graph Visualization Extension
class LoudnessControlSuiteGraph : public PluginSDK::GraphVisualization {
public:
	LoudnessControlSuiteGraph();
	virtual ~LoudnessControlSuiteGraph();
...
public:
	...
	LoudnessControlSuiteGraph& GetGraph() { return graph; }
	const LoudnessControlSuiteGraph& GetGraph() const { return graph; }
...
private:
	...
	LoudnessControlSuiteGraph graph;           // Graph visualization interface
