#ifndef _effects_modspatialsuite_modspatialsuite_h_
#define _effects_modspatialsuite_modspatialsuite_h_
...
// ModSpatialSuite Graph Visualization Extension
class ModSpatialSuiteGraph : public PluginSDK::GraphVisualization {
public:
	ModSpatialSuiteGraph();
	virtual ~ModSpatialSuiteGraph();
...
class ModSpatialSuite : public PluginSDK::PluginProcessor {
public:
	typedef ModSpatialSuite CLASSNAME;
	ModSpatialSuite();
	virtual ~ModSpatialSuite();
	...
	ModSpatialSuiteGraph& GetGraph() { return graph; }
	const ModSpatialSuiteGraph& GetGraph() const { return graph; }
...
private:
	...
	ModSpatialSuiteGraph graph;           // Graph visualization interface
