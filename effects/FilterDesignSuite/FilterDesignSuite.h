...
// FilterDesignSuite Graph Visualization Extension
class FilterDesignSuiteGraph : public PluginSDK::GraphVisualization {
public:
	FilterDesignSuiteGraph();
	virtual ~FilterDesignSuiteGraph();
...
public:
	...
	FilterDesignSuiteGraph& GetGraph() { return graph; }
	const FilterDesignSuiteGraph& GetGraph() const { return graph; }
...
private:
	...
	FilterDesignSuiteGraph graph;           // Graph visualization interface
