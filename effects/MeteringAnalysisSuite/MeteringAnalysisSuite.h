...
// MeteringAnalysisSuite Graph Visualization Extension
class MeteringAnalysisSuiteGraph : public PluginSDK::GraphVisualization {
public:
	MeteringAnalysisSuiteGraph();
	virtual ~MeteringAnalysisSuiteGraph();
...
public:
	...
	MeteringAnalysisSuiteGraph& GetGraph() { return graph; }
	const MeteringAnalysisSuiteGraph& GetGraph() const { return graph; }
...
private:
	...
	MeteringAnalysisSuiteGraph graph;           // Graph visualization interface
