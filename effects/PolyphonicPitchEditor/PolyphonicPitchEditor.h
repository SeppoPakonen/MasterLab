#ifndef _effects_polyphonicpitcheditor_polyphonicpitcheditor_h_
#define _effects_polyphonicpitcheditor_polyphonicpitcheditor_h_
...
// PolyphonicPitchEditor Graph Visualization Extension
class PolyphonicPitchEditorGraph : public PluginSDK::GraphVisualization {
public:
	PolyphonicPitchEditorGraph();
	virtual ~PolyphonicPitchEditorGraph();
...
class PolyphonicPitchEditor : public PluginSDK::PluginProcessor {
public:
	typedef PolyphonicPitchEditor CLASSNAME;
	PolyphonicPitchEditor();
	virtual ~PolyphonicPitchEditor();
	...
	PolyphonicPitchEditorGraph& GetGraph() { return graph; }
	const PolyphonicPitchEditorGraph& GetGraph() const { return graph; }
...
private:
	...
	PolyphonicPitchEditorGraph graph;           // Graph visualization interface
