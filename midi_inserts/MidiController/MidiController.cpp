...
void MidiController::Prepare(const PluginSDK::AudioConfig& cfg) {
...
void MidiController::Process(PluginSDK::ProcessContext& ctx, Vector<PluginSDK::NoteEvent>& in_notes,
