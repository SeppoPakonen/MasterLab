#ifndef _midi_inserts_midiecho_midiecho_h_
#define _midi_inserts_midiecho_midiecho_h_

#include <PluginSDK/PluginSDK.h>

namespace MidiInserts {

class MidiEcho : public PluginSDK::MidiEffectProcessor {
public:
	typedef MidiEcho CLASSNAME;
	MidiEcho();
