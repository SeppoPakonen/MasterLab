#ifndef _midi_inserts_autolfo_autolfo_h_
#define _midi_inserts_autolfo_autolfo_h_

#include <PluginSDK/PluginSDK.h>

namespace MidiInserts {

class AutoLFO : public PluginSDK::MidiEffectProcessor {
public:
	typedef AutoLFO CLASSNAME;
	AutoLFO();
