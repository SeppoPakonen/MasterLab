#ifndef _midi_inserts_stepdesigner_stepdesigner_h_
#define _midi_inserts_stepdesigner_stepdesigner_h_

#include <PluginSDK/PluginSDK.h>

namespace MidiInserts {

class StepDesigner : public PluginSDK::MidiEffectProcessor {
public:
	typedef StepDesigner CLASSNAME;
	StepDesigner();
