# Conversion Note: `ui/configenv_ui.ui`

## Source
- `tmp/k/src/ui/configenv_ui.ui`

## Target
- `src/Cool/ui/ConfigenvUiConversion.md`
...
SPDX-License-Identifier: GPL-3.0-only OR LicenseRef-KDE-Accepted-GPL
 ...
 <widget class="QWidget" name="ConfigEnv_UI">
  ...
  <layout class="QVBoxLayout" name="verticalLayout">
   ...
   <item>
    <widget class="QCheckBox" name="kcfg_showWelcome">
     <property name="text">
      <string>Show Welcome screen at startup</string>
     </property>
    </widget>
   </item>
   <item>
 ...
 <tabstops>
  ...
  <tabstop>kcfg_showWelcome</tabstop>
  <tabstop>kcfg_checkForUpdate</tabstop>
  <tabstop>kcfg_usePowerManagement</tabstop>
