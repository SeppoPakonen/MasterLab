# Conversion Note: `ui/titlewidget_ui.ui`

## Source
- `tmp/k/src/ui/titlewidget_ui.ui`

## Target
- `src/Cool/ui/TitlewidgetUiConversion.md`
...
SPDX-License-Identifier: GPL-3.0-only OR LicenseRef-KDE-Accepted-GPL
  ...
  <layout class="QGridLayout" name="gridLayout_7">
   <item row="9" column="0" colspan="9">
    <layout class="QHBoxLayout" name="horizontalLayout">
     ...
     <item>
      <widget class="QFrame" name="timecode_frame">
    ...
    <widget class="QFrame" name="frame_properties">
     ...
     <layout class="QGridLayout" name="gridLayout">
      ...
      <item row="0" column="12">
       <widget class="QLabel" name="label_zIndex">
        <property name="text">
   ...
   <item row="8" column="0" colspan="9">
    <widget class="QSplitter" name="splitter">
     ...
     <widget class="QWidget" name="verticalLayoutWidget_2">
      <layout class="QGridLayout" name="grid_settings">
       <property name="leftMargin">
        <number>6</number>
       </property>
       <property name="rightMargin">
       ...
       <item row="1" column="1">
        <widget class="QSpinBox" name="itemzoom">
         <property name="maximum">
       ...
       <item row="2" column="1">
        <layout class="QHBoxLayout" name="horizontalLayout_3">
         ...
         <item>
          <widget class="QSpinBox" name="itemrotatey">
           <property name="sizePolicy">
            <sizepolicy hsizetype="MinimumExpanding" vsizetype="Fixed">
             <horstretch>0</horstretch>
             <verstretch>0</verstretch>
       ...
       <item row="1" column="0">
        <widget class="QLabel" name="label_itemzoom">
         <property name="text">
          <string>Zoom:</string>
         </property>
        </widget>
       ...
       <item row="3" column="0" colspan="2">
        <widget class="QFrame" name="align_frame">
         <property name="sizePolicy">
         ...
         <layout class="QHBoxLayout" name="horizontalLayout_2">
          ...
          <item>
           <widget class="QToolButton" name="itemleft">
            <property name="toolTip">
             <string>Align item to left.</string>
            </property>
            <property name="text">
             <string>...</string>
            </property>
          ...
          <item>
           <widget class="QToolButton" name="itemhcenter">
            <property name="toolTip">
             <string>Align item horizontally.</string>
            </property>
            <property name="text">
             <string>...</string>
            </property>
          ...
          <item>
           <widget class="QToolButton" name="itemright">
            <property name="toolTip">
             <string>Align item to right.</string>
            </property>
            <property name="text">
             <string>...</string>
            </property>
          ...
          <item>
           <widget class="QToolButton" name="itemtop">
            <property name="toolTip">
             <string>Align item to top.</string>
            </property>
            <property name="text">
             <string>...</string>
            </property>
          ...
          <item>
           <widget class="QToolButton" name="itemvcenter">
            <property name="toolTip">
             <string>Align item vertically.</string>
            </property>
            <property name="text">
             <string>...</string>
            </property>
          ...
          <item>
           <widget class="QToolButton" name="itembottom">
            <property name="toolTip">
             <string>Align item to bottom.</string>
            </property>
            <property name="text">
             <string>...</string>
            </property>
       ...
       <item row="0" column="1">
        <widget class="TimecodeDisplay" name="m_duration"/>
       </item>
       <item row="4" column="0" colspan="2">
        <widget class="QTabWidget" name="tabWidget">
            ...
            <widget class="QStackedWidget" name="toolbar_stack">
                 ...
                 <widget class="QWidget" name="scrollAreaWidgetContents">
                  ...
                  <layout class="QGridLayout" name="gridLayout_9">
                   ...
                   <item row="9" column="0" colspan="7">
                    <widget class="QGroupBox" name="typewriterBox">
                     <property name="title">
                      <string>&amp;Typewriter effect</string>
                     </property>
                     <property name="checkable">
                      <bool>true</bool>
                     </property>
                     ...
                     <layout class="QGridLayout" name="gridLayout_12">
                      <item row="0" column="2">
                       <widget class="QLabel" name="label_variation">
                        <property name="text">
                      ...
                      <item row="2" column="0" colspan="4">
                       <widget class="QGroupBox" name="groupBox_2">
                        ...
                        <layout class="QGridLayout" name="gridLayout_4">
                         <item row="0" column="0">
                          <widget class="QRadioButton" name="tw_rd_char">
                           <property name="text">
                            <string>B&amp;y char</string>
                           </property>
                           <property name="checked">
                            <bool>true</bool>
                           </property>
                         ...
                         <item row="0" column="1">
                          <widget class="QRadioButton" name="tw_rd_word">
                           <property name="text">
                         ...
                         <item row="1" column="0">
                          <widget class="QRadioButton" name="tw_rd_line">
                           <property name="text">
                         ...
                         <item row="1" column="1">
                          <widget class="QRadioButton" name="tw_rd_custom">
                           <property name="text">
                      ...
                      <item row="0" column="0">
                       <widget class="QLabel" name="label_frameStep">
                        <property name="text">
                      ...
                      <item row="0" column="3">
                       <widget class="QSpinBox" name="tw_sb_sigma">
                        <property name="maximum">
                         <number>240</number>
                        </property>
                       </widget>
                      ...
                      <item row="1" column="3">
                       <widget class="QSpinBox" name="tw_sb_seed">
                        <property name="maximum">
                         <number>9999</number>
                        </property>
                       </widget>
                      ...
                      <item row="0" column="1">
                       <widget class="QSpinBox" name="tw_sb_step">
                        <property name="minimum">
                         <number>1</number>
                        </property>
                        <property name="maximum">
                   ...
                   <item row="7" column="0">
                    <widget class="QLabel" name="label_letterSpacing">
                     <property name="text">
             ...
             <widget class="QWidget" name="rectangle">
              <layout class="QGridLayout" name="gridLayout_2">
               ...
               <item row="2" column="0">
                <widget class="QLabel" name="label_border">
                 <property name="text">
         ...
         <widget class="QWidget" name="tab_background">
          <attribute name="title">
           <string>Background</string>
          </attribute>
         ...
         <widget class="QWidget" name="tab_patterns">
          <attribute name="title">
          ...
          <layout class="QVBoxLayout" name="verticalLayout">
           ...
           <item>
            <widget class="QListView" name="patternsList">
           ...
           <item>
            <layout class="QHBoxLayout" name="horizontalLayout_4">
             ...
             <item>
              <widget class="QToolButton" name="btn_removeAll">
               <property name="toolTip">
 ...
 <tabstops>
  <tabstop>origin_x_left</tabstop>
  <tabstop>value_x</tabstop>
  <tabstop>origin_y_top</tabstop>
  <tabstop>value_y</tabstop>
  <tabstop>value_w</tabstop>
  <tabstop>value_h</tabstop>
  <tabstop>zUp</tabstop>
  <tabstop>zDown</tabstop>
  <tabstop>zTop</tabstop>
  <tabstop>zBottom</tabstop>
  <tabstop>zValue</tabstop>
  <tabstop>buttonSelectImages</tabstop>
  <tabstop>buttonSelectText</tabstop>
  <tabstop>buttonUnselectAll</tabstop>
  <tabstop>buttonSelectAll</tabstop>
  <tabstop>buttonSelectRects</tabstop>
  <tabstop>use_grid</tabstop>
  <tabstop>show_guides</tabstop>
  <tabstop>vguides</tabstop>
  <tabstop>hguides</tabstop>
  <tabstop>guideColor</tabstop>
  <tabstop>buttonFitZoom</tabstop>
  <tabstop>buttonRealSize</tabstop>
  <tabstop>zoom_slider</tabstop>
  <tabstop>zoom_spin</tabstop>
  <tabstop>displayBg</tabstop>
  <tabstop>bgBox</tabstop>
  <tabstop>createButton</tabstop>
  <tabstop>cancelButton</tabstop>
  <tabstop>itemrotatex</tabstop>
  <tabstop>itemrotatey</tabstop>
  <tabstop>itemrotatez</tabstop>
  <tabstop>rectBColor</tabstop>
  <tabstop>gradient_rect</tabstop>
  <tabstop>scrollArea</tabstop>
  <tabstop>font_size</tabstop>
  <tabstop>font_weight_box</tabstop>
  <tabstop>buttonUnder</tabstop>
  <tabstop>buttonItalic</tabstop>
  <tabstop>plain_color</tabstop>
  <tabstop>fontColorButton</tabstop>
  <tabstop>buttonInsertUnicode</tabstop>
  <tabstop>gradient_color</tabstop>
  <tabstop>gradients_combo</tabstop>
  <tabstop>edit_gradient</tabstop>
  <tabstop>textOutline</tabstop>
  <tabstop>textOutlineColor</tabstop>
  <tabstop>shadowBox</tabstop>
  <tabstop>blur_radius</tabstop>
  <tabstop>shadowColor</tabstop>
  <tabstop>shadowX</tabstop>
  <tabstop>shadowY</tabstop>
  <tabstop>buttonAlignLeft</tabstop>
  <tabstop>buttonAlignCenter</tabstop>
  <tabstop>buttonAlignRight</tabstop>
  <tabstop>letter_spacing</tabstop>
  <tabstop>line_spacing</tabstop>
  <tabstop>backgroundColor</tabstop>
  <tabstop>bgAlphaSlider</tabstop>
  <tabstop>backgroundAlpha</tabstop>
  <tabstop>anim_start</tabstop>
  <tabstop>anim_end</tabstop>
  <tabstop>keep_aspect</tabstop>
  <tabstop>resize50</tabstop>
  <tabstop>resize100</tabstop>
  <tabstop>resize200</tabstop>
  <tabstop>patternsList</tabstop>
  <tabstop>btn_add</tabstop>
  <tabstop>btn_remove</tabstop>
  <tabstop>btn_removeAll</tabstop>
  <tabstop>scaleSlider</tabstop>
  <tabstop>rectFColor</tabstop>
  <tabstop>font_family</tabstop>
  <tabstop>gradients_rect_combo</tabstop>
  <tabstop>preserveAspectRatio</tabstop>
  <tabstop>edit_rect_gradient</tabstop>
  <tabstop>rectLineWidth</tabstop>
  <tabstop>plain_rect</tabstop>
 </tabstops>
 <resources/>
 <connections>
  <connection>
  ...
  <connection>
   <sender>plain_color</sender>
   <signal>toggled(bool)</signal>
   <receiver>fontColorButton</receiver>
   <slot>setEnabled(bool)</slot>
   <hints>
    <hint type="sourcelabel">
     <x>523</x>
  ...
  <connection>
   ...
   <signal>toggled(bool)</signal>
   <receiver>gradients_combo</receiver>
   <slot>setEnabled(bool)</slot>
   <hints>
    <hint type="sourcelabel">
     <x>523</x>
  ...
  <connection>
   <sender>gradient_rect</sender>
   <signal>toggled(bool)</signal>
   <receiver>gradients_rect_combo</receiver>
   <slot>setEnabled(bool)</slot>
   <hints>
    <hint type="sourcelabel">
     <x>523</x>
  ...
  <connection>
   <sender>bgAlphaSlider</sender>
   <signal>valueChanged(int)</signal>
   <receiver>backgroundAlpha</receiver>
  ...
  <connection>
   <sender>plain_rect</sender>
   <signal>toggled(bool)</signal>
   <receiver>rectBColor</receiver>
   <slot>setEnabled(bool)</slot>
   <hints>
    <hint type="sourcelabel">
     <x>523</x>
  ...
  <connection>
   <sender>backgroundAlpha</sender>
   <signal>valueChanged(int)</signal>
   <receiver>bgAlphaSlider</receiver>
   <slot>setValue(int)</slot>
   <hints>
    <hint type="sourcelabel">
     <x>994</x>
