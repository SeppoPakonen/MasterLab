# Conversion Note: `ui/configsdl_ui.ui`

## Source
- `tmp/k/src/ui/configsdl_ui.ui`

## Target
- `src/Cool/ui/ConfigsdlUiConversion.md`
  ...
  <layout class="QFormLayout" name="formLayout">
   <item row="0" column="0">
    <widget class="QLabel" name="label">
     <property name="text">
      <string>Play/pause monitor on mouse click</string>
     </property>
    </widget>
   </item>
   <item row="0" column="1">
    <widget class="QCheckBox" name="kcfg_play_monitor_on_click">
     <property name="text">
   ...
   <item row="4" column="0">
    <widget class="QLabel" name="label_gpu">
     <property name="text">
      <string>GPU processing (Movit library):</string>
     </property>
    </widget>
   </item>
   <item row="4" column="1">
    <widget class="QCheckBox" name="kcfg_gpu_accel">
     <property name="text">
      <string>Enable - restart Kdenlive to apply</string>
     </property>
    </widget>
   </item>
   ...
   <item row="6" column="0">
    <widget class="QLabel" name="label_audio_backend">
     <property name="text">
   ...
   <item row="7" column="0">
    <widget class="QLabel" name="label_audio_driver">
   ...
   <item row="10" column="0">
    <widget class="QLabel" name="label_2">
     <property name="text">
      <string>External display (Blackmagic card):</string>
     </property>
    </widget>
   </item>
