# Conversion Note: `ui/managecache_ui.ui`

## Source
- `tmp/k/src/ui/managecache_ui.ui`

## Target
- `src/Cool/ui/ManagecacheUiConversion.md`
...
SPDX-License-Identifier: GPL-3.0-only OR LicenseRef-KDE-Accepted-GPL
 ...
 <class>ManageCache_UI</class>
 <widget class="QDialog" name="ManageCache_UI">
  ...
  <property name="windowTitle">
   <string>Manage Cache Data</string>
  </property>
  <layout class="QVBoxLayout" name="verticalLayout">
   <item>
    <widget class="QTabWidget" name="tabWidget">
      ...
      <layout class="QVBoxLayout" name="verticalLayout_3">
       <item>
        <layout class="QGridLayout" name="gridLayout" rowstretch="0,0,0,0,0,0,0,0,0">
         <item row="2" column="3">
          <widget class="QLabel" name="audioSize">
           <property name="text">
            <string>0 B</string>
           </property>
          </widget>
         ...
         <item row="7" column="4">
          <widget class="QToolButton" name="delCurrent">
         ...
         <item row="3" column="4">
          <widget class="QToolButton" name="delThumb">
           <property name="enabled">
            <bool>false</bool>
           </property>
           <property name="text">
         ...
         <item row="3" column="3">
          <widget class="QLabel" name="thumbSize">
           <property name="text">
            <string>0 B</string>
           </property>
          </widget>
         ...
         <item row="1" column="4">
          <widget class="QToolButton" name="delProxy">
           <property name="enabled">
            <bool>false</bool>
           </property>
           <property name="text">
         ...
         <item row="6" column="0" colspan="5">
          <widget class="QFrame" name="seperator1">
         ...
         <item row="2" column="4">
          <widget class="QToolButton" name="delAudio">
           <property name="enabled">
            <bool>false</bool>
           </property>
           <property name="text">
         ...
         <item row="3" column="1">
          <widget class="QLabel" name="thumbColor">
         ...
         <item row="1" column="1">
          <widget class="QLabel" name="proxyColor">
           <property name="autoFillBackground">
            <bool>true</bool>
           </property>
           <property name="text">
         ...
         <item row="1" column="3">
          <widget class="QLabel" name="proxySize">
           <property name="text">
            <string>0 B</string>
           </property>
          </widget>
         ...
         <item row="4" column="1">
          <widget class="QLabel" name="sequenceColor">
           <property name="autoFillBackground">
            <bool>true</bool>
           </property>
           <property name="text">
         ...
         <item row="2" column="2">
          <widget class="QLabel" name="audioLabel">
           <property name="text">
            <string>Audio thumbnails:</string>
           </property>
          </widget>
         </item>
         <item row="7" column="3">
         ...
         <item row="0" column="3">
          <widget class="QLabel" name="previewSize">
           <property name="text">
            <string>0 B</string>
           </property>
          </widget>
         ...
         <item row="8" column="0" colspan="5">
          <widget class="QLabel" name="currentPath">
           <property name="toolTip">
            <string>Click to open cache folder.</string>
           </property>
           <property name="text">
            <string>&lt;a href='#'&gt;/home/user/.cache/kdenlive/1617522274308&lt;/a&gt;</string>
           </property>
          </widget>
         </item>
         <item row="4" column="3">
          <widget class="QLabel" name="sequenceSize">
           <property name="text">
            <string>0 B</string>
           </property>
          </widget>
         ...
         <item row="7" column="0" colspan="3">
          <widget class="QLabel" name="currentLabel">
           <property name="text">
            <string>Project total cache data:</string>
           </property>
          </widget>
         </item>
         <item row="0" column="1">
          <widget class="QLabel" name="previewColor">
           <property name="autoFillBackground">
            <bool>true</bool>
           </property>
           <property name="text">
         ...
         <item row="0" column="0" rowspan="6">
          <layout class="QHBoxLayout" name="currentChartBox"/>
         </item>
         <item row="2" column="1">
          <widget class="QLabel" name="audioColor">
           <property name="autoFillBackground">
            <bool>true</bool>
           </property>
           <property name="text">
         ...
         <item row="0" column="4">
          <widget class="QToolButton" name="delPreview">
           <property name="enabled">
            <bool>false</bool>
           </property>
           <property name="text">
     ...
     <widget class="QWidget" name="globalPage">
      <property name="accessibleName">
       <string>Current Project</string>
      </property>
      ...
      <layout class="QVBoxLayout" name="verticalLayout_2">
        ...
        <layout class="QHBoxLayout" name="gChartLayout">
         <item>
          <widget class="QTreeWidget" name="listWidget">
           ...
           <column>
            <property name="text">
             <string extracomment="Filesize">Size</string>
            </property>
           </column>
           <column>
            <property name="text">
        ...
        <layout class="QHBoxLayout" name="cleanupLayout" stretch="0,0">
         <item>
          <widget class="QLabel" name="gCleanupLabel">
           <property name="text">
            <string>Cleanup will delete data older than:</string>
           </property>
          </widget>
         </item>
         <item>
          <widget class="QSpinBox" name="gCleanupSpin">
       ...
       <item>
        <widget class="KMessageWidget" name="cache_info">
 ...
 <connections>
  <connection>
   ...
   <receiver>ManageCache_UI</receiver>
   <slot>accept()</slot>
   <hints>
