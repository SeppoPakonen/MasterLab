# Conversion Note: `ui/textbasededit_ui.ui`

## Source
- `tmp/k/src/ui/textbasededit_ui.ui`

## Target
- `src/Cool/ui/TextbasededitUiConversion.md`
  ...
  <layout class="QGridLayout" name="gridLayout_2">
   ...
   <item row="6" column="0">
    <layout class="QHBoxLayout" name="horizontalLayout_2">
     <item>
      <widget class="QToolButton" name="button_config">
       <property name="text">
        <string>...</string>
       </property>
   ...
   <item row="4" column="0">
    <widget class="QFrame" name="edit_frame">
     ...
     <layout class="QGridLayout" name="gridLayout">
      ...
      <item row="0" column="4">
       <widget class="QToolButton" name="button_remove_silence">
        <property name="text">
         <string>...</string>
        </property>
        <property name="autoRaise">
      ...
      <item row="0" column="7">
       <widget class="QToolButton" name="button_font_more">
        <property name="text">
         <string>...</string>
        </property>
        <property name="autoRaise">
      ...
      <item row="0" column="8">
       <widget class="QToolButton" name="button_font_less">
        <property name="text">
         <string>...</string>
        </property>
        <property name="autoRaise">
