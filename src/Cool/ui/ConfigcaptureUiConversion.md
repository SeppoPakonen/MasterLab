# Conversion Note: `ui/configcapture_ui.ui`

## Source
- `tmp/k/src/ui/configcapture_ui.ui`

## Target
- `src/Cool/ui/ConfigcaptureUiConversion.md`
  ...
  <layout class="QGridLayout" name="gridLayout_8">
   ...
   <item row="1" column="0" colspan="2">
    <widget class="QTabWidget" name="tabWidget">
     ...
     <widget class="QWidget" name="screen_grab_tab">
      ...
      <layout class="QFormLayout" name="formLayout_3">
       <item row="0" column="0">
        <widget class="QLabel" name="label_8">
         <property name="text">
          <string>Region to capture:</string>
         </property>
        </widget>
       </item>
       <item row="0" column="1">
       ...
       <item row="1" column="1">
        <widget class="QFrame" name="region_group">
         ...
         <layout class="QGridLayout" name="gridLayout_3">
          ...
          <item row="1" column="1">
           <widget class="QSpinBox" name="kcfg_grab_offsetx">
            <property name="sizePolicy">
             <sizepolicy hsizetype="Expanding" vsizetype="Fixed">
              <horstretch>0</horstretch>
              <verstretch>0</verstretch>
          ...
          <item row="1" column="2">
           <widget class="QSpinBox" name="kcfg_grab_offsety">
            <property name="sizePolicy">
             <sizepolicy hsizetype="Expanding" vsizetype="Fixed">
              <horstretch>0</horstretch>
              <verstretch>0</verstretch>
          ...
          <item row="2" column="1">
           <widget class="QSpinBox" name="kcfg_grab_width">
          ...
          <item row="2" column="2">
           <widget class="QSpinBox" name="kcfg_grab_height">
            <property name="minimum">
             <number>1</number>
            </property>
            <property name="maximum">
       ...
       <item row="3" column="1">
        <widget class="QDoubleSpinBox" name="kcfg_grab_fps">
         <property name="minimum">
       ...
       <item row="4" column="1">
        <layout class="QHBoxLayout" name="screen_grab_profile_box"/>
       </item>
       <item row="5" column="1">
     ...
     <widget class="QWidget" name="decklink_tab">
      <attribute name="title">
      ...
      <layout class="QFormLayout" name="formLayout">
       ...
       <item row="1" column="1">
        <layout class="QHBoxLayout" name="decklink_profile_box">
     ...
     <widget class="QWidget" name="audio_tab">
      ...
      <layout class="QFormLayout" name="formLayout_2">
       ...
       <item row="0" column="1">
        <widget class="QComboBox" name="defaultaudiocapture"/>
       </item>
       <item row="2" column="0">
