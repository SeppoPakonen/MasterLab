# Conversion Note: `ui/configtimeline_ui.ui`

## Source
- `tmp/k/src/ui/configtimeline_ui.ui`

## Target
- `src/Cool/ui/ConfigtimelineUiConversion.md`
...
SPDX-License-Identifier: GPL-3.0-only OR LicenseRef-KDE-Accepted-GPL
  ...
  <layout class="QFormLayout" name="formLayout">
   ...
   <item row="0" column="1">
    <widget class="QCheckBox" name="kcfg_videothumbnails">
     <property name="text">
      <string>Enable for Video</string>
     </property>
    </widget>
   </item>
   <item row="1" column="1">
    <widget class="QCheckBox" name="kcfg_audiothumbnails">
     <property name="text">
      <string>Enable for Audio</string>
     </property>
    </widget>
   </item>
   <item row="2" column="1">
    <widget class="QCheckBox" name="kcfg_displayallchannels">
     ...
     <property name="text">
      <string>Separate audio channels</string>
     </property>
    </widget>
   </item>
   ...
   <item row="4" column="0">
    <widget class="QLabel" name="label_5">
     <property name="text">
      <string>Playback and Seeking:</string>
     </property>
    </widget>
   </item>
   <item row="4" column="1">
   ...
   <item row="5" column="1">
    <widget class="QCheckBox" name="kcfg_jumptostart">
     <property name="text">
      <string>Jump to timeline start if playback is started on last frame in timeline</string>
     </property>
    </widget>
   </item>
   <item row="6" column="1">
   ...
   <item row="16" column="0">
    <widget class="QLabel" name="label">
     <property name="text">
      <string>Default track height:</string>
     </property>
    </widget>
   </item>
   ...
   <item row="19" column="1">
    <widget class="QCheckBox" name="kcfg_uiDebugMode">
     <property name="text">
   ...
   <item row="8" column="1">
    <widget class="QGroupBox" name="groupBox_2">
     <property name="title">
      <string>Raise Effects/Composition Stack for</string>
     </property>
     <layout class="QGridLayout" name="gridLayout_2">
      <item row="0" column="1">
       <widget class="QCheckBox" name="kcfg_raisepropscompositions">
        <property name="text">
      ...
      <item row="0" column="2">
       <widget class="QCheckBox" name="kcfg_raisepropsmixes">
        <property name="text">
         <string>Mixes</string>
        </property>
       </widget>
 ...
 <tabstops>
  ...
  <tabstop>kcfg_raisepropscompositions</tabstop>
  <tabstop>kcfg_raisepropsmixes</tabstop>
  ...
  <tabstop>kcfg_uiDebugMode</tabstop>
 </tabstops>
 <resources/>
 <connections>
  <connection>
