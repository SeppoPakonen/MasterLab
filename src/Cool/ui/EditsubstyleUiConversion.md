# Conversion Note: `ui/editsubstyle_ui.ui`

## Source
- `tmp/k/src/ui/editsubstyle_ui.ui`

## Target
- `src/Cool/ui/EditsubstyleUiConversion.md`
...
SPDX-License-Identifier: GPL-3.0-only OR LicenseRef-KDE-Accepted-GPL
 ...
 <class>SubtitleStyleEdit_UI</class>
 <widget class="QDialog" name="SubtitleStyleEdit_UI">
  ...
  <property name="windowTitle">
   <string>Subtitle Style Editor</string>
  </property>
  <layout class="QGridLayout" name="gridLayout">
   ...
   <item row="0" column="7" rowspan="12">
   ...
   <item row="1" column="0" colspan="6">
    <layout class="QHBoxLayout" name="horizontalLayout_3">
     ...
     <item>
      <widget class="QToolButton" name="buttonSelectFont">
       <property name="text">
        <string/>
       </property>
       <property name="icon">
        <iconset theme="font-enable"/>
       </property>
      </widget>
     </item>
     <item>
   ...
   <item row="3" column="2">
    <widget class="QPushButton" name="buttonPrimaryColor">
     <property name="text">
      <string/>
     </property>
    </widget>
   ...
   <item row="3" column="3">
    <widget class="QLabel" name="labelSecondaryColor">
     <property name="text">
   ...
   <item row="3" column="4">
    <widget class="KContextualHelpButton" name="kcontextualhelpbutton">
     <property name="contextualHelpText">
      <string>The secondary color might be used in case of subtitle collision to help distinguish both subtitles</string>
     </property>
    </widget>
   </item>
   <item row="3" column="5">
    <widget class="QPushButton" name="buttonSecondaryColor">
     <property name="text">
      <string/>
     </property>
    </widget>
   ...
   <item row="4" column="2">
    <widget class="QSpinBox" name="spinOutline">
     <property name="maximum">
   ...
   <item row="4" column="3" colspan="3">
    <widget class="QPushButton" name="buttonOutlineColor">
     <property name="text">
      <string/>
     </property>
    </widget>
   ...
   <item row="5" column="2">
    <widget class="QSpinBox" name="spinShadow">
     <property name="maximum">
      <number>100000</number>
     </property>
    </widget>
   ...
   <item row="5" column="3" colspan="3">
    <widget class="QPushButton" name="buttonBackColor">
     <property name="text">
      <string/>
     </property>
    </widget>
   ...
   <item row="6" column="0" colspan="2">
    <widget class="QLabel" name="labelBoarderStyle">
     <property name="text">
   ...
   <item row="6" column="2">
    <widget class="QComboBox" name="comboBorderStyle"/>
   </item>
   <item row="6" column="5">
   ...
   <item row="7" column="3" colspan="2">
    <widget class="QLabel" name="labelSpacing">
     <property name="text">
      <string>Character spacing</string>
     </property>
     <property name="alignment">
      <set>Qt::AlignmentFlag::AlignRight|Qt::AlignmentFlag::AlignTrailing|Qt::AlignmentFlag::AlignVCenter</set>
     </property>
   ...
   <item row="8" column="1">
    <widget class="QLabel" name="labelMarginL">
     <property name="text">
   ...
   <item row="9" column="0" colspan="2">
    <widget class="QLabel" name="labelMarginV">
     <property name="text">
   ...
   <item row="9" column="2">
    <widget class="QSpinBox" name="spinMarginV">
     <property name="minimum">
      <number>-100000</number>
     </property>
     <property name="maximum">
   ...
   <item row="12" column="7">
    <widget class="QLineEdit" name="editPreview">
     <property name="enabled">
      <bool>true</bool>
     </property>
    </widget>
   ...
   <item row="2" column="0" colspan="6">
    <layout class="QHBoxLayout" name="horizontalLayout">
     ...
     <item>
      <widget class="QCheckBox" name="checkStrikeOut">
       <property name="sizePolicy">
        <sizepolicy hsizetype="Minimum" vsizetype="Fixed">
         <horstretch>0</horstretch>
         <verstretch>0</verstretch>
   ...
   <item row="8" column="3" colspan="2">
    <widget class="QLabel" name="labelMarginR">
     <property name="text">
 ...
 <tabstops>
  ...
  <tabstop>buttonSelectFont</tabstop>
  <tabstop>spinFontSize</tabstop>
  <tabstop>checkBold</tabstop>
  <tabstop>checkItalic</tabstop>
  <tabstop>checkUnderline</tabstop>
  <tabstop>checkStrikeOut</tabstop>
  <tabstop>buttonPrimaryColor</tabstop>
  <tabstop>kcontextualhelpbutton</tabstop>
  <tabstop>buttonSecondaryColor</tabstop>
  <tabstop>spinOutline</tabstop>
  <tabstop>buttonOutlineColor</tabstop>
  <tabstop>spinShadow</tabstop>
  <tabstop>buttonBackColor</tabstop>
  <tabstop>comboBorderStyle</tabstop>
  <tabstop>comboAlignment</tabstop>
  <tabstop>spinAngle</tabstop>
  <tabstop>spinSpacing</tabstop>
  <tabstop>spinMarginL</tabstop>
  <tabstop>spinMarginR</tabstop>
  <tabstop>spinMarginV</tabstop>
  <tabstop>spinScaleX</tabstop>
  <tabstop>spinScaleY</tabstop>
 ...
 <connections>
  <connection>
   ...
   <receiver>SubtitleStyleEdit_UI</receiver>
   <slot>accept()</slot>
   <hints>
