# Conversion Note: `ui/guideslist_ui.ui`

## Source
- `tmp/k/src/ui/guideslist_ui.ui`

## Target
- `src/Cool/ui/GuideslistUiConversion.md`
...
SPDX-License-Identifier: GPL-3.0-only OR LicenseRef-KDE-Accepted-GPL
 ...
 <class>GuidesList_UI</class>
 <widget class="QWidget" name="GuidesList_UI">
  ...
  <layout class="QGridLayout" name="gridLayout">
   ...
   <item row="0" column="0" colspan="3">
    <layout class="QHBoxLayout" name="horizontalLayout_2">
     ...
     <item>
      <widget class="QToolButton" name="show_all">
       <property name="text">
        <string>...</string>
       </property>
       <property name="icon">
   ...
   <item row="3" column="0" colspan="3">
    <layout class="QHBoxLayout" name="horizontalLayout">
     ...
     <item>
      <widget class="QToolButton" name="guides_lock">
       <property name="text">
        <string>...</string>
       </property>
       <property name="checkable">
     ...
     <item>
      <widget class="QToolButton" name="thumbs_refresh">
       <property name="text">
        <string>...</string>
       </property>
       <property name="icon">
