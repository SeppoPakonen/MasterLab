# Conversion Note: `ui/editsub_ui.ui`

## Source
- `tmp/k/src/ui/editsub_ui.ui`

## Target
- `src/Cool/ui/EditsubUiConversion.md`
...
<ui version="4.0">
      ...
      <layout class="QGridLayout" name="gridLayout_10">
            ...
            <widget class="QWidget" name="page">
             <layout class="QGridLayout" name="gridLayout_7">
              ...
              <item row="1" column="0" colspan="6">
               <widget class="SubtitleTextEdit" name="subText">
              ...
              <item row="2" column="0" colspan="6">
               <widget class="KTextEdit" name="simpleSubText"/>
              </item>
              <item row="7" column="1">
              ...
              <item row="4" column="1">
               <widget class="QToolButton" name="buttonEditStyle">
                <property name="text">
                 <string>...</string>
                </property>
                <property name="icon">
              ...
              <item row="0" column="0" colspan="6">
               <layout class="QHBoxLayout" name="horizontalLayout_4" stretch="0,0,0,0,0,0,0,0,0">
                ...
                <item>
                 <widget class="QToolButton" name="buttonResetStyle">
                  <property name="text">
                   <string>...</string>
                  </property>
                  <property name="icon">
                   <iconset theme="edit-paste-style"/>
                  </property>
                 </widget>
                </item>
                <item>
                 <widget class="QToolButton" name="buttonMoreTags">
                  <property name="text">
                   <string/>
                  </property>
                  <property name="icon">
                   <iconset theme="view-more-symbolic"/>
                  </property>
                ...
                <item>
                 <widget class="QSpinBox" name="subLayer">
              ...
              <item row="3" column="0" colspan="6">
               <layout class="QHBoxLayout" name="horizontalLayout_5">
                <item>
                 <widget class="QLabel" name="char_count">
                ...
                <item>
                 <widget class="QToolButton" name="subMenu">
                  <property name="text">
                   <string>...</string>
                  </property>
                  <property name="icon">
               ...
               <widget class="QScrollArea" name="scrollArea_3">
                ...
                <widget class="QWidget" name="scrollAreaWidgetContents_3">
                 ...
                 <layout class="QGridLayout" name="gridLayout_9">
                  ...
                  <item row="0" column="3">
                   <widget class="QComboBox" name="scrollDirection"/>
                  </item>
                  ...
                  <item row="6" column="3">
                   <widget class="QSpinBox" name="scrollSpeed">
                    <property name="minimum">
                     <number>1</number>
                    </property>
                    <property name="maximum">
                  ...
                  <item row="7" column="3">
                   <widget class="QSpinBox" name="scrollUpper">
                    <property name="minimum">
                     <number>-99999</number>
                    </property>
                    <property name="maximum">
                  ...
                  <item row="8" column="3">
                   <widget class="QSpinBox" name="scrollLower">
                    <property name="minimum">
                     <number>-99999</number>
                    </property>
                    <property name="maximum">
                  ...
                  <item row="7" column="0" colspan="3">
                   <widget class="QLabel" name="labelScrollUpper">
                    <property name="text">
                  ...
                  <item row="6" column="0" colspan="3">
                   <widget class="QLabel" name="labelScrollSpeed">
                    <property name="text">
                     <string>Speed</string>
                    </property>
                    <property name="alignment">
                  ...
                  <item row="12" column="0" colspan="4">
                   <widget class="KTextEdit" name="editEffects">
                    <property name="inputMethodHints">
                     <set>Qt::InputMethodHint::ImhNone</set>
                    </property>
                   </widget>
                  ...
                  <item row="8" column="0" colspan="3">
                   <widget class="QLabel" name="lavelScrollLower">
                    <property name="text">
                  ...
                  <item row="10" column="0" colspan="3">
                   <widget class="QCheckBox" name="checkComment">
                    <property name="text">
       ...
       <item row="1" column="0">
        <layout class="QHBoxLayout" name="horizontalLayout_6">
         ...
         <item>
          <widget class="QToolButton" name="buttonMoreOption">
           <property name="text">
            <string>...</string>
           </property>
           <property name="icon">
 ...
 <customwidgets>
  ...
  <customwidget>
   <class>SubtitleTextEdit</class>
   <extends>QTextEdit</extends>
   <header>widgets/subtitletextedit.h</header>
  </customwidget>
 </customwidgets>
 <resources/>
 <connections/>
