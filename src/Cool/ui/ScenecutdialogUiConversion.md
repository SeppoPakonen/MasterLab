# Conversion Note: `ui/scenecutdialog_ui.ui`

## Source
- `tmp/k/src/ui/scenecutdialog_ui.ui`

## Target
- `src/Cool/ui/ScenecutdialogUiConversion.md`
...
SPDX-License-Identifier: GPL-3.0-only OR LicenseRef-KDE-Accepted-GPL
 ...
 <widget class="QDialog" name="SceneCutDialog_UI">
  ...
  <layout class="QGridLayout" name="gridLayout">
   ...
   <item row="2" column="0" colspan="4">
    <widget class="QCheckBox" name="range_markers">
     <property name="enabled">
      <bool>false</bool>
     </property>
     <property name="text">
      <string>Create range markers</string>
     </property>
    </widget>
   </item>
  </layout>
 ...
 <connections>
  ...
  <connection>
   <sender>add_markers</sender>
   <signal>toggled(bool)</signal>
   <receiver>range_markers</receiver>
   <slot>setEnabled(bool)</slot>
   <hints>
    <hint type="sourcelabel">
     <x>99</x>
