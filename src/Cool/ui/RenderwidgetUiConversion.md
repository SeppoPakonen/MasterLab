# Conversion Note: `ui/renderwidget_ui.ui`

## Source
- `tmp/k/src/ui/renderwidget_ui.ui`

## Target
- `src/Cool/ui/RenderwidgetUiConversion.md`
    ...
    <widget class="QTabWidget" name="tabWidget">
     ...
     <widget class="QWidget" name="renderTab">
      ...
      <layout class="QHBoxLayout" name="horizontalLayout1">
       <item>
        <widget class="QFrame" name="baseGroup">
         <layout class="QGridLayout" name="gridLayout_2">
          ...
          <item row="4" column="0">
           <widget class="QGroupBox" name="guide_zone_box">
            <property name="title">
             <string/>
            </property>
                 ...
                 <layout class="QHBoxLayout" name="horizontalLayout">
                  ...
                  <item>
                   <widget class="KNSWidgets::Button" name="m_knsbutton">
                    ...
                    <property name="configFile" stdset="0">
                  ...
                  <item>
                   <widget class="QToolButton" name="buttonSaveAs">
                    ...
                    <property name="toolTip">
                     <string>Save current preset as new custom preset</string>
                    </property>
                    <property name="text">
          ...
          <item row="5" column="0">
           <widget class="QGroupBox" name="guide_multi_box">
            <property name="title">
             <string>Markers Multi-Export</string>
            </property>
            ...
            <layout class="QHBoxLayout" name="horizontalLayout_3">
             <item>
              <widget class="QLabel" name="label">
               <property name="text">
                <string>Markers to use as separator:</string>
               </property>
              </widget>
             </item>
             <item>
       ...
       <item>
        <widget class="QScrollArea" name="optionsGroup">
         <property name="frameShape">
         ...
         <widget class="QWidget" name="scrollAreaWidgetContents">
          ...
          <layout class="QVBoxLayout" name="verticalLayout">
           ...
           <item>
            <widget class="QGroupBox" name="video_box">
             ...
             <layout class="QFormLayout" name="formLayout_4">
              <item row="2" column="1">
               <widget class="QCheckBox" name="render_full_color">
                <property name="text">
                 <string>Render full color range</string>
                </property>
               </widget>
              </item>
              <item row="4" column="1">
              ...
              <item row="0" column="1">
               <widget class="QComboBox" name="interp_type"/>
              </item>
              <item row="0" column="0">
              ...
              <item row="1" column="1">
               <widget class="QComboBox" name="deinterlacer_type"/>
              </item>
              <item row="1" column="0">
              ...
              <item row="9" column="1">
               <widget class="QComboBox" name="aspect_ratio_type"/>
              </item>
             </layout>
            </widget>
           </item>
             ...
             <layout class="QFormLayout" name="formLayout">
              <item row="0" column="0">
               <widget class="QCheckBox" name="stemAudioExport">
                <property name="text">
                 <string>Separate file for each audio track</string>
                </property>
               </widget>
              </item>
             </layout>
           ...
           <item>
            <widget class="QGroupBox" name="qualityGroup">
             ...
             <layout class="QVBoxLayout" name="verticalLayout_2">
              <item>
               <layout class="QHBoxLayout" name="sliderGroup">
                <item>
                ...
                <item>
                 <widget class="QLabel" name="qualityPercent">
                  <property name="text">
                   <string>75%</string>
                  </property>
                 </widget>
             ...
             <layout class="QFormLayout" name="formLayout_2">
              ...
              <item row="2" column="1">
               <widget class="QSpinBox" name="encoder_threads">
                ...
                <property name="toolTip">
                 <string>Encoding threads</string>
                </property>
           ...
           <item>
            <widget class="QCheckBox" name="keep_log_files">
             <property name="text">
              <string>Keep log files</string>
             </property>
            </widget>
           </item>
           <item>
     ...
     <widget class="QWidget" name="jobTab">
      ...
      <layout class="QGridLayout" name="gridLayout2">
       ...
       <item row="2" column="0" colspan="6">
        <widget class="KMessageWidget" name="jobInfo">
         <property name="closeButtonVisible">
          <bool>false</bool>
         </property>
        </widget>
