# Conversion Note: `ui/configmisc_ui.ui`

## Source
- `tmp/k/src/ui/configmisc_ui.ui`

## Target
- `src/Cool/ui/ConfigmiscUiConversion.md`
...
SPDX-License-Identifier: GPL-3.0-only OR LicenseRef-KDE-Accepted-GPL
  ...
  <layout class="QFormLayout" name="formLayout">
   ...
   <item row="1" column="1">
    <layout class="QHBoxLayout" name="horizontalLayout_3">
     ...
     <item>
      <widget class="QSpinBox" name="kcfg_autosave_time">
     ...
     <item>
      <widget class="QSpinBox" name="kcfg_autosave_ops">
       <property name="suffix">
   ...
   <item row="4" column="1">
    <widget class="QCheckBox" name="kcfg_keep_original_frame_size">
     <property name="text">
      <string>Keep clip original frame size on import</string>
     </property>
    </widget>
   </item>
   <item row="5" column="1">
    ...
    <layout class="QHBoxLayout" name="horizontalLayout">
     <item>
      <widget class="QCheckBox" name="kcfg_ignoresubdirstructure">
       <property name="text">
        <string>Ignore subfolder structure on import</string>
       </property>
      </widget>
     </item>
     <item>
      <widget class="KContextualHelpButton" name="kcontextualhelpbutton">
       <property name="contextualHelpText">
        <string>This will import all files into a toplevel folder</string>
       </property>
      </widget>
     </item>
    </layout>
   ...
   <item row="12" column="1">
    <layout class="QHBoxLayout" name="horizontalLayout_2">
     ...
     <item>
      <widget class="QCheckBox" name="kcfg_enableBuiltInEffects">
       <property name="text">
        <string>Enable Built-in Effects</string>
       </property>
      </widget>
     </item>
     <item>
      <widget class="KContextualHelpButton" name="kcontextualhelpbutton_2">
       <property name="contextualHelpText">
        <string>Enabling built-in effects will add basic effects like volume and transform to all clips for easy access</string>
       </property>
      </widget>
     </item>
    </layout>
   ...
   <item row="15" column="0">
    <widget class="QLabel" name="label_10">
     <property name="text">
      <string>Preferred track compositing composition:</string>
     </property>
    </widget>
   </item>
 ...
 <tabstops>
  <tabstop>kcfg_openlastproject</tabstop>
  <tabstop>kcfg_crashrecovery</tabstop>
  <tabstop>kcfg_autosave_time</tabstop>
  <tabstop>kcfg_autosave_ops</tabstop>
  <tabstop>kcfg_checkfirstprojectclip</tabstop>
  <tabstop>kcfg_keep_original_frame_size</tabstop>
  <tabstop>kcfg_automultistreams</tabstop>
  ...
  <tabstop>kcfg_disable_effect_parameters</tabstop>
  <tabstop>kcfg_enableBuiltInEffects</tabstop>
  <tabstop>kcontextualhelpbutton_2</tabstop>
  ...
  <tabstop>kcfg_mix_duration</tabstop>
  <tabstop>kcfg_image_duration</tabstop>
  <tabstop>kcfg_sequence_duration</tabstop>
