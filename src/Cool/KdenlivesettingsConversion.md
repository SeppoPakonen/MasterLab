# Conversion Note: `kdenlivesettings.kcfg`

## Source
- `tmp/k/src/kdenlivesettings.kcfg`

## Target
- `src/Cool/KdenlivesettingsConversion.md`
...
<kcfg xmlns="http://www.kde.org/standards/kcfg/1.0"
  ...
  <group name="jobs">
    ...
    <entry name="scenesplitrangemarkers" type="Bool">
      <label>Add range markers on Scene split.</label>
      <default>true</default>
    </entry>
  ...
  <group name="misc">
    ...
    <entry name="autosave_time" type="Int">
      <label>Autosave frequency in seconds.</label>
      <default>60</default>
    </entry>
    <entry name="autosave_ops" type="Int">
      <label>Autosave when we reach this count of undo entries.</label>
      <default>25</default>
    </entry>
    ...
    <entry name="keep_original_frame_size" type="Bool">
      <label>On clip import, add a Transform effect to keep the clip's original frame size.</label>
      <default>false</default>
    </entry>
    ...
    <entry name="assetsInfoHeight" type="Double">
      <label>Height of the info box.</label>
      <default>0</default>
    </entry>
  ...
  <group name="project">
    ...
    <entry name="proxyalphaextension" type="String">
      <label>File extension for proxy clips.</label>
      <default></default>
    </entry>

    <entry name="proxyalphaparams" type="String">
      <label>Proxy clips transcoding parameters.</label>
      <default></default>
    </entry>

    <entry name="alpha_profile" type="Int">
      <label>default proxy encoding profile.</label>
      <default>0</default>
    </entry>
    ...
    <entry name="hwDecoding" type="String">
      <label>Enable hw decoding. String must be vaapi, nvdec, etc</label>
      <default></default>
    </entry>
  ...
  <group name="timeline">
    ...
    <entry name="draginprogress" type="Bool">
      <label>True when a timeline drag operation is in progress.</label>
      <default>false</default>
    </entry>
    ...
    <entry name="waveformScaler" type="Int">
      <label>Vertical scaler for audio waveform.</label>
      <default>1</default>
    </entry>
    ...
    <entry name="enableBuiltInEffects" type="Bool">
      <label>Enable built-in effects.</label>
      <default>false</default>
    </entry>

    <entry name="tenbitpipeline" type="Bool">
      <label>Hide all effects that are not compatible with 10 bit.</label>
      <default>false</default>
    </entry>

    <entry name="effectsFilter" type="Bool">
      <label>Filter effects by property.</label>
      <default>false</default>
    </entry>

    <entry name="transitionsFilter" type="Bool">
      <label>Filter transitions by property.</label>
      <default>false</default>
    </entry>
    ...
    <entry name="raisepropscompositions" type="Bool">
      <label>Raise property pane when selecting timeline compositions.</label>
      <default>true</default>
    </entry>

    <entry name="raisepropsmixes" type="Bool">
      <label>Raise property pane when selecting timeline mixes.</label>
      <default>true</default>
    </entry>
    ...
    <entry name="uiDebugMode" type="Bool">
      <label>Enable technical elements and info to debug the UI (for developers)</label>
      <default>false</default>
    </entry>
...
<group name="tools">
  ...
  <group name="env">
    ...
    <entry name="usePowerManagement" type="Bool">
      <label>Disable sleep on playback/render</label>
      <default>true</default>
    </entry>
    ...
    <entry name="guidesShowThumbs" type="Bool">
      <label>Display markers thumbnails in guide dialog.</label>
      <default>false</default>
    </entry>
    <entry name="guidesSelectZone" type="Bool">
      <label>Select zone when selecting a range marker.</label>
      <default>false</default>
    </entry>
  ...
  <group name="Recent Profiles">
    <entry name="recentProfiles" type="StringList">
         <label>List of recently used profile ids</label>
         <default></default>
    </entry>
    <entry name="recentProfileNames" type="StringList">
         <label>List of recently used profile display names</label>
         <default></default>
    </entry>
  </group>
  ...
  <group name="unmanaged">
    ...
    <entry name="kdockLayout" type="String">
      <label>Default project layout.</label>
      <default></default>
    </entry>
    <entry name="layoutsOrder" type="StringList">
      <label>Project layout order</label>
      <default>logging,editing,audio,effects,color</default>
    </entry>
    ...
    <entry name="showClipOverlays" type="Bool">
      <label>Show clip name and infos in timeline.</label>
      <default>true</default>
    </entry>
    <entry name="rippleResize" type="Bool">
      <label>Enable Ripple edit when changing multiple clips duration.</label>
      <default>false</default>
    </entry>
    ...
    <entry name="keepRenderLogFiles" type="Bool">
      <label>Should we delete log files after successful render.</label>
      <default>false</default>
    </entry>
    ...
    <entry name="showClipMonitorSafeZone" type="Bool">
      <label>Show monitor safe zones.</label>
      <default>false</default>
    </entry>
    <entry name="showProjectMonitorSafeZone" type="Bool">
      <label>Show monitor safe zones.</label>
      <default>false</default>
    </entry>
    ...
    <entry name="limitAutoKeyframes" type="Int">
      <label>Limit the frequency of created keyframes when playing.</label>
      <default>0</default>
    </entry>
    <entry name="limitAutoKeyframesInterval" type="Int">
      <label>Default interval for auto keyframes limit when playing.</label>
      <default>10</default>
    </entry>
    <entry name="maskOpacity" type="Int">
      <label>Opacity of object masks on monitor.</label>
      <default>100</default>
    </entry>
    <entry name="maskInverted" type="Bool">
      <label>Invert alpha mask display.</label>
      <default>false</default>
    </entry>
    ...
    <entry name="safeColor" type="Color">
      <label>Color to draw the safe zone.</label>
  ...
  <group name="startup">
    ...
    <entry name="showWelcome" type="Bool">
      <label>Show Welcome page on Start.</label>
      <default>true</default>
    </entry>
    <entry name="lastSeenVersionMajor" type="Int">
      <label>Last used version of Kdenlive - major.</label>
      <default>0</default>
    </entry>
    <entry name="lastSeenVersionMinor" type="Int">
      <label>Last used version of Kdenlive - minor.</label>
      <default>0</default>
    </entry>
    <entry name="lastSeenVersionMicro" type="Int">
      <label>Last used version of Kdenlive - micro.</label>
      <default>0</default>
    </entry>
  ...
  <group name="titles">
   ...
   <group name="sam">
     <entry name="samModelFile" type="String">
       <label>Path for the chosen sam model.</label>
       <default></default>
     </entry>
     <entry name="sam_offload_video" type="Bool">
       <label>Offload video to CPU to reduce memory use.</label>
       <default>false</default>
     </entry>
     <entry name="sam_system_python" type="Bool">
       <label>Use system packages for SAM plugin</label>
       <default>false</default>
     </entry>
     <entry name="sam_system_python_path" type="Path">
       <label>Path to python exec for SAM.</label>
       <default></default>
     </entry>
     <entry name="maskBorderWidth" type="Int">
       <label>Default border width for mask.</label>
       <default>0</default>
     </entry>
     <entry name="maskBorderColor" type="Color">
       <label>Default border color for mask.</label>
       <default>#64FF6464</default>
     </entry>
     <entry name="maskColor" type="Color">
       <label>Default color for mask.</label>
       <default>#B4FF6464</default>
     </entry>
   </group>
   <group name="speech">
     <entry name="speech_system_python" type="Bool">
       <label>Use system packages for STT plugin</label>
       <default>false</default>
     </entry>
     <entry name="speech_system_python_path" type="Path">
       <label>Path to python exec for STT.</label>
       <default></default>
     </entry>
       ...
       <entry name="whisperModel" type="String">
           <label>Last selected model for automatic subtitling</label>
           <default>turbo</default>
       </entry>
       <entry name="whisperInstalledModels" type="StringList">
         <label>The list of already downloaded models</label>
         <default></default>
       </entry>
       <entry name="whisperAvailableModels" type="StringList">
         <label>The list of available models, with modelname=filename</label>
         <default>tiny.en=tiny.en.pt,tiny=tiny.pt,base.en=base.en.pt,base=base.pt,small.en=small.en.pt,small=small.pt,medium.en=medium.en.pt,medium=medium.pt,large-v1=large-v1.pt,large-v2=large-v2.pt,large-v3=large-v3.pt,large=large-v3.pt,large-v3-turbo=large-v3-turbo.pt,turbo=large-v3-turbo.pt</default>
       </entry>
       <entry name="whisperAvailableModelsHash" type="StringList">
         <label>The list of available models, with filename=hash</label>
         <default></default>
       </entry>
       <entry name="whisperModelFolder" type="String">
         <label>The path to models downloads</label>
         <default></default>
       </entry>
       ...
       <entry name="samDevice" type="String">
           <label>Device for data processing</label>
           <default>cpu</default>
       </entry>
    ...
    <entry name="mediaManagerPanelLayout" type="String">
      <label>Show preview panel in browser.</label>
      <default></default>
    </entry>
    <entry name="mediaManagerPanelWidth" type="Int">
      <label>Default width for the preview panel.</label>
      <default>0</default>
    </entry>
    <entry name="mediaBrowserAutoPlay" type="Bool">
      <label>Autoplay preview in panel.</label>
      <default>false</default>
    </entry>
    <entry name="mediaBrowserWithAudio" type="Bool">
      <label>Play audio in browser.</label>
      <default>true</default>
    </entry>
    <entry name="mediaDoubleClickImport" type="Bool">
      <label>Double click on a file imports it to the project.</label>
        <default>true</default>
    </entry>
    <entry name="mediaBrowserInlinePreview" type="Bool">
