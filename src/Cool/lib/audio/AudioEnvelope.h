// Converted from tmp/k/src/lib/audio/audioEnvelope.h
...
public:
    explicit AudioEnvelope(const QString &binId, int clipId, std::pair<int, int> stream = {-1, -1}, size_t offset = 0, size_t length = 0, size_t startPos = 0);
