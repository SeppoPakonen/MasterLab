    ...
    : QWidget(parent)
{
    ...
    m_redEdit->setButtonSymbols(QAbstractSpinBox::NoButtons);
    m_redEdit->setAlignment(Qt::AlignCenter);
    ...
    m_greenEdit->setButtonSymbols(QAbstractSpinBox::NoButtons);
    m_greenEdit->setAlignment(Qt::AlignCenter);
    ...
    m_blueEdit->setButtonSymbols(QAbstractSpinBox::NoButtons);
    m_blueEdit->setAlignment(Qt::AlignCenter);
