// Converted from tmp/k/src/assets/keyframes/model/corners/cornershelper.hpp
...
public:
     ...
     */
    explicit CornersHelper(Monitor *monitor, std::shared_ptr<AssetParameterModel> model, QObject *parent = nullptr);
