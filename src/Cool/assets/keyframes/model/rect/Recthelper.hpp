// Converted from tmp/k/src/assets/keyframes/model/rect/recthelper.hpp
...
public:
     ...
     */
    explicit RectHelper(Monitor *monitor, std::shared_ptr<AssetParameterModel> model, QObject *parent = nullptr);
