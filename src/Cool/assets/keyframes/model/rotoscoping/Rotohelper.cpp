...
// Converted from tmp/k/src/assets/keyframes/model/rotoscoping/rotohelper.cpp
...
void RotoHelper::refreshParams(int pos)
{
    ...
    if (!keyframes->isEmpty()) {
        const QVariant splineData = keyframes->getInterpolatedValue(pos, m_indexes.first());
