# Task: Convert `qtractorConnectForm.h` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorConnectForm.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorConnectForm.h`
...
## Conversion Notes
- Write the converted source into `src/VSTConnections/qtractorConnectForm.h` or the closest package-local equivalent once the package manifest is updated.
