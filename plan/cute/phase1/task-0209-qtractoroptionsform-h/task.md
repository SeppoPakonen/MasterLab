# Task: Convert `qtractorOptionsForm.h` to U++
# Status: DONE

## Objective
Manually read `tmp/q/src/qtractorOptionsForm.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorOptionsForm.h`
...
## Conversion Notes
- Write the converted source into `src/Preferences/qtractorOptionsForm.h` or the closest package-local equivalent once the package manifest is updated.
