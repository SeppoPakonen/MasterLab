# Task: Convert `qtractorPluginListView.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/q/src/qtractorPluginListView.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorPluginListView.cpp`
...
## Conversion Notes
- Write the converted source into `src/VSTHost/qtractorPluginListView.cpp` or the closest package-local equivalent once the package manifest is updated.
