# Task: Convert `qtractorRubberBand.h` to U++
# Status: DONE

## Objective
Manually read `tmp/q/src/qtractorRubberBand.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorRubberBand.h`
...
## Conversion Notes
- Write the converted source into `src/ProjectWindow/qtractorRubberBand.h` or the closest package-local equivalent once the package manifest is updated.
