# Task: Convert `qtractorMidiControlPluginWidget.h` to U++
# Status: DONE

## Objective
Manually read `tmp/q/src/qtractorMidiControlPluginWidget.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorMidiControlPluginWidget.h`
...
## Conversion Notes
- Write the converted source into `src/VSTHost/qtractorMidiControlPluginWidget.h` or the closest package-local equivalent once the package manifest is updated.
