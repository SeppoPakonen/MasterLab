# Task: Convert `qtractorSession.h` to U++
# Status: DONE

## Objective
Manually read `tmp/q/src/qtractorSession.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorSession.h`
...
## Conversion Notes
- Write the converted source into `src/AudioCore/qtractorSession.h` or the closest package-local equivalent once the package manifest is updated.
