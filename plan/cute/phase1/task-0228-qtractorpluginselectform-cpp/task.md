# Task: Convert `qtractorPluginSelectForm.cpp` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorPluginSelectForm.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorPluginSelectForm.cpp`
...
## Conversion Notes
- Write the converted source into `src/VSTHost/qtractorPluginSelectForm.cpp` or the closest package-local equivalent once the package manifest is updated.
