# Task: Convert `qtractorInstrument.cpp` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorInstrument.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorInstrument.cpp`
...
## Conversion Notes
- Write the converted source into `src/MIDI/qtractorInstrument.cpp` or the closest package-local equivalent once the package manifest is updated.
