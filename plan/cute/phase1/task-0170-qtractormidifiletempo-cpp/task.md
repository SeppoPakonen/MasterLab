# Task: Convert `qtractorMidiFileTempo.cpp` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorMidiFileTempo.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorMidiFileTempo.cpp`
...
## Conversion Notes
- Write the converted source into `src/MIDI/qtractorMidiFileTempo.cpp` or the closest package-local equivalent once the package manifest is updated.
