# Task: Convert `qtractorPluginForm.h` to U++
# Status: DONE

## Objective
Manually read `tmp/q/src/qtractorPluginForm.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorPluginForm.h`
...
## Conversion Notes
- Write the converted source into `src/VSTHost/qtractorPluginForm.h` or the closest package-local equivalent once the package manifest is updated.
