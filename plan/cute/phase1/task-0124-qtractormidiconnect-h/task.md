# Task: Convert `qtractorMidiConnect.h` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorMidiConnect.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorMidiConnect.h`
...
## Conversion Notes
- Write the converted source into `src/Devices/qtractorMidiConnect.h` or the closest package-local equivalent once the package manifest is updated.
