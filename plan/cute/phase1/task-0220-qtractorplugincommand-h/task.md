# Task: Convert `qtractorPluginCommand.h` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorPluginCommand.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorPluginCommand.h`
...
## Conversion Notes
- Write the converted source into `src/VSTHost/qtractorPluginCommand.h` or the closest package-local equivalent once the package manifest is updated.
