# Task: Convert `qtractorAudioFile.cpp` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorAudioFile.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorAudioFile.cpp`
...
## Conversion Notes
- Write the converted source into `src/AudioCore/qtractorAudioFile.cpp` or the closest package-local equivalent once the package manifest is updated.
