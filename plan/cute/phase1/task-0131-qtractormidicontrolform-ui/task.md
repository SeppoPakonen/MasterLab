# Task: Convert `qtractorMidiControlForm.ui` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorMidiControlForm.ui` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorMidiControlForm.ui`
