# Task: Convert `qtractorTrackButton.cpp` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorTrackButton.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorTrackButton.cpp`
...
## Conversion Notes
- Write the converted source into `src/ProjectWindow/qtractorTrackButton.cpp` or the closest package-local equivalent once the package manifest is updated.
