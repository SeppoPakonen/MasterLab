# Task: Convert `qtractorEditRangeForm.cpp` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorEditRangeForm.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorEditRangeForm.cpp`
...
## Conversion Notes
- Write the converted source into `src/AudioEditing/qtractorEditRangeForm.cpp` or the closest package-local equivalent once the package manifest is updated.
