# Task: Convert `qtractorPluginFactory.h` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorPluginFactory.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorPluginFactory.h`
...
## Conversion Notes
- Write the converted source into `src/VSTHost/qtractorPluginFactory.h` or the closest package-local equivalent once the package manifest is updated.
