# Task: Convert `qtractorMidiEditCommand.cpp` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorMidiEditCommand.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorMidiEditCommand.cpp`
...
## Conversion Notes
- Write the converted source into `src/MIDI/qtractorMidiEditCommand.cpp` or the closest package-local equivalent once the package manifest is updated.
