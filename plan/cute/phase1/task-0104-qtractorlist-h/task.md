# Task: Convert `qtractorList.h` to U++
# Status: DONE

## Objective
Manually read `tmp/q/src/qtractorList.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorList.h`
...
## Conversion Notes
- Write the converted source into `src/Tooling/qtractorList.h` or the closest package-local equivalent once the package manifest is updated.
