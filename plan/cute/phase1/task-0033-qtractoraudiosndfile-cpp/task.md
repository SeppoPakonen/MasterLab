# Task: Convert `qtractorAudioSndFile.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/q/src/qtractorAudioSndFile.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorAudioSndFile.cpp`
...
## Conversion Notes
- Write the converted source into `src/AudioCore/qtractorAudioSndFile.cpp` or the closest package-local equivalent once the package manifest is updated.
