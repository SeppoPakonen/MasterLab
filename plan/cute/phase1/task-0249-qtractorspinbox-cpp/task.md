# Task: Convert `qtractorSpinBox.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/q/src/qtractorSpinBox.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorSpinBox.cpp`
...
## Conversion Notes
- Write the converted source into `src/TransportUI/qtractorSpinBox.cpp` or the closest package-local equivalent once the package manifest is updated.
