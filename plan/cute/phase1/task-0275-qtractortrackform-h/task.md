# Task: Convert `qtractorTrackForm.h` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorTrackForm.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorTrackForm.h`
...
## Conversion Notes
- Write the converted source into `src/ProjectWindow/qtractorTrackForm.h` or the closest package-local equivalent once the package manifest is updated.
