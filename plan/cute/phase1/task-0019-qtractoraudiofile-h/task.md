# Task: Convert `qtractorAudioFile.h` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorAudioFile.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorAudioFile.h`
...
## Conversion Notes
- Write the converted source into `src/AudioCore/qtractorAudioFile.h` or the closest package-local equivalent once the package manifest is updated.
