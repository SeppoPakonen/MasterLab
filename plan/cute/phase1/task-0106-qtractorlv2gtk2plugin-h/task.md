# Task: Convert `qtractorLv2Gtk2Plugin.h` to U++
# Status: DONE

## Objective
Manually read `tmp/q/src/qtractorLv2Gtk2Plugin.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorLv2Gtk2Plugin.h`
...
## Conversion Notes
- Write the converted source into `src/VSTHost/qtractorLv2Gtk2Plugin.h` or the closest package-local equivalent once the package manifest is updated.
