# Task: Convert `qtractorMidiSequence.h` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorMidiSequence.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorMidiSequence.h`
...
## Conversion Notes
- Write the converted source into `src/MIDI/qtractorMidiSequence.h` or the closest package-local equivalent once the package manifest is updated.
