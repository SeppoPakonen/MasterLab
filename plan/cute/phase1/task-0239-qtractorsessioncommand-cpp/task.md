# Task: Convert `qtractorSessionCommand.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/q/src/qtractorSessionCommand.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorSessionCommand.cpp`
...
## Conversion Notes
- Write the converted source into `src/ProjectMgmt/qtractorSessionCommand.cpp` or the closest package-local equivalent once the package manifest is updated.
