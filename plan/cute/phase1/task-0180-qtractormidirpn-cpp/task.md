# Task: Convert `qtractorMidiRpn.cpp` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorMidiRpn.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorMidiRpn.cpp`
...
## Conversion Notes
- Write the converted source into `src/MIDI/qtractorMidiRpn.cpp` or the closest package-local equivalent once the package manifest is updated.
