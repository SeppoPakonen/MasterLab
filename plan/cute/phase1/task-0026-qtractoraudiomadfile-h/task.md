# Task: Convert `qtractorAudioMadFile.h` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorAudioMadFile.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorAudioMadFile.h`
...
## Conversion Notes
- Write the converted source into `src/AudioCore/qtractorAudioMadFile.h` or the closest package-local equivalent once the package manifest is updated.
