# Task: Convert `qtractorAudioIOMatrixForm.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/q/src/qtractorAudioIOMatrixForm.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorAudioIOMatrixForm.cpp`
...
## Conversion Notes
- Write the converted source into `src/VSTConnections/qtractorAudioIOMatrixForm.cpp` or the closest package-local equivalent once the package manifest is updated.
