# Task: Convert `qtractorOptions.h` to U++
# Status: DONE

## Objective
Manually read `tmp/q/src/qtractorOptions.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorOptions.h`
...
## Conversion Notes
- Write the converted source into `src/Preferences/qtractorOptions.h` or the closest package-local equivalent once the package manifest is updated.
