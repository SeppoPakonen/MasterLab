# Task: Convert `qtractorRubberBand.cpp` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorRubberBand.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorRubberBand.cpp`
...
## Conversion Notes
- Write the converted source into `src/ProjectWindow/qtractorRubberBand.cpp` or the closest package-local equivalent once the package manifest is updated.
