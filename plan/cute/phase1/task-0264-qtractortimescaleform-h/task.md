# Task: Convert `qtractorTimeScaleForm.h` to U++
# Status: DONE

## Objective
Manually read `tmp/q/src/qtractorTimeScaleForm.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorTimeScaleForm.h`
...
## Conversion Notes
- Write the converted source into `src/TransportUI/qtractorTimeScaleForm.h` or the closest package-local equivalent once the package manifest is updated.
