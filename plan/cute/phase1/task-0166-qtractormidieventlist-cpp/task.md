# Task: Convert `qtractorMidiEventList.cpp` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorMidiEventList.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorMidiEventList.cpp`
...
## Conversion Notes
- Write the converted source into `src/MIDI/qtractorMidiEventList.cpp` or the closest package-local equivalent once the package manifest is updated.
