# Task: Convert `qtractorScrollView.cpp` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorScrollView.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorScrollView.cpp`
...
## Conversion Notes
- Write the converted source into `src/ProjectWindow/qtractorScrollView.cpp` or the closest package-local equivalent once the package manifest is updated.
