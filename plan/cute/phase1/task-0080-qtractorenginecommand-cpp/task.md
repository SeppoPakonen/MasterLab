# Task: Convert `qtractorEngineCommand.cpp` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorEngineCommand.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorEngineCommand.cpp`
...
## Conversion Notes
- Write the converted source into `src/ProjectMgmt/qtractorEngineCommand.cpp` or the closest package-local equivalent once the package manifest is updated.
