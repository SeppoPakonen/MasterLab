# Task: Convert `qtractorLv2Plugin.cpp` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorLv2Plugin.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorLv2Plugin.cpp`
...
## Conversion Notes
- Write the converted source into `src/VSTHost/qtractorLv2Plugin.cpp` or the closest package-local equivalent once the package manifest is updated.
