# Task: Convert `qtractorCtlEvent.h` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorCtlEvent.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorCtlEvent.h`
...
## Conversion Notes
- Write the converted source into `src/MIDI/qtractorCtlEvent.h` or the closest package-local equivalent once the package manifest is updated.
