# Task: Convert `qtractorPluginCommand.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/q/src/qtractorPluginCommand.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorPluginCommand.cpp`
...
## Conversion Notes
- Write the converted source into `src/VSTHost/qtractorPluginCommand.cpp` or the closest package-local equivalent once the package manifest is updated.
