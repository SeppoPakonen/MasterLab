...
## Source
- `tmp/q/src/qtractorPluginForm.cpp`
...
## Conversion Notes
- Write the converted source into `src/VSTHost/qtractorPluginForm.cpp` or the closest package-local equivalent once the package manifest is updated.
