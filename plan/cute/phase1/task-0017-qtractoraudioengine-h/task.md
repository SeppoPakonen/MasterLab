# Task: Convert `qtractorAudioEngine.h` to U++
# Status: DONE

## Objective
Manually read `tmp/q/src/qtractorAudioEngine.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorAudioEngine.h`
...
## Conversion Notes
- Write the converted source into `src/AudioCore/qtractorAudioEngine.h` or the closest package-local equivalent once the package manifest is updated.
