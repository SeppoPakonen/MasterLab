# Task: Convert `qtractorCurveSelect.cpp` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorCurveSelect.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorCurveSelect.cpp`
...
## Conversion Notes
- Write the converted source into `src/AudioEditing/qtractorCurveSelect.cpp` or the closest package-local equivalent once the package manifest is updated.
