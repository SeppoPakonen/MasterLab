# Task: Convert `qtractorDssiPlugin.h` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorDssiPlugin.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorDssiPlugin.h`
...
## Conversion Notes
- Write the converted source into `src/VSTHost/qtractorDssiPlugin.h` or the closest package-local equivalent once the package manifest is updated.
