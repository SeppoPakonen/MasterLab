# Task: Convert `qtractorInstrumentMenu.h` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorInstrumentMenu.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorInstrumentMenu.h`
...
## Conversion Notes
- Write the converted source into `src/MIDI/qtractorInstrumentMenu.h` or the closest package-local equivalent once the package manifest is updated.
