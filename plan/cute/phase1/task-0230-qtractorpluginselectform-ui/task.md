# Task: Convert `qtractorPluginSelectForm.ui` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorPluginSelectForm.ui` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorPluginSelectForm.ui`
