# Task: Convert `qtractorMidiEditCommand.h` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorMidiEditCommand.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorMidiEditCommand.h`
...
## Conversion Notes
- Write the converted source into `src/MIDI/qtractorMidiEditCommand.h` or the closest package-local equivalent once the package manifest is updated.
