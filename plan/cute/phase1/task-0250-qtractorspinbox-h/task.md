# Task: Convert `qtractorSpinBox.h` to U++
# Status: DONE

## Objective
Manually read `tmp/q/src/qtractorSpinBox.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorSpinBox.h`
...
## Conversion Notes
- Write the converted source into `src/TransportUI/qtractorSpinBox.h` or the closest package-local equivalent once the package manifest is updated.
