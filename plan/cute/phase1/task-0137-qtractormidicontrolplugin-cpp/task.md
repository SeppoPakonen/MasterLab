# Task: Convert `qtractorMidiControlPlugin.cpp` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorMidiControlPlugin.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorMidiControlPlugin.cpp`
...
## Conversion Notes
- Write the converted source into `src/VSTHost/qtractorMidiControlPlugin.cpp` or the closest package-local equivalent once the package manifest is updated.
