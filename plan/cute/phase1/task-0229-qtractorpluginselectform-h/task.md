# Task: Convert `qtractorPluginSelectForm.h` to U++
# Status: DONE

## Objective
Manually read `tmp/q/src/qtractorPluginSelectForm.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorPluginSelectForm.h`
...
## Conversion Notes
- Write the converted source into `src/VSTHost/qtractorPluginSelectForm.h` or the closest package-local equivalent once the package manifest is updated.
