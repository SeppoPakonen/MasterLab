# Task: Convert `qtractorAudioPeak.h` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorAudioPeak.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorAudioPeak.h`
...
## Conversion Notes
- Write the converted source into `src/AudioCore/qtractorAudioPeak.h` or the closest package-local equivalent once the package manifest is updated.
