# Task: Convert `qtractorLv2Plugin.h` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorLv2Plugin.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorLv2Plugin.h`
...
## Conversion Notes
- Write the converted source into `src/VSTHost/qtractorLv2Plugin.h` or the closest package-local equivalent once the package manifest is updated.
