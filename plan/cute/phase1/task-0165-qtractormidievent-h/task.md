# Task: Convert `qtractorMidiEvent.h` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorMidiEvent.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorMidiEvent.h`
...
## Conversion Notes
- Write the converted source into `src/MIDI/qtractorMidiEvent.h` or the closest package-local equivalent once the package manifest is updated.
