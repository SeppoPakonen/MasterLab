# Task: Convert `qtractorTrackView.cpp` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorTrackView.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorTrackView.cpp`
...
## Conversion Notes
- Write the converted source into `src/ProjectWindow/qtractorTrackView.cpp` or the closest package-local equivalent once the package manifest is updated.
