# Task: Convert `qtractorMidiControlPluginWidget.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/q/src/qtractorMidiControlPluginWidget.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorMidiControlPluginWidget.cpp`
...
## Conversion Notes
- Write the converted source into `src/VSTHost/qtractorMidiControlPluginWidget.cpp` or the closest package-local equivalent once the package manifest is updated.
