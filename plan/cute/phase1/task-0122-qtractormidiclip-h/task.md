# Task: Convert `qtractorMidiClip.h` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorMidiClip.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorMidiClip.h`
...
## Conversion Notes
- Write the converted source into `src/MIDI/qtractorMidiClip.h` or the closest package-local equivalent once the package manifest is updated.
