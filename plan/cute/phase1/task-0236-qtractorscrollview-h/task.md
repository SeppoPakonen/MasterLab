# Task: Convert `qtractorScrollView.h` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorScrollView.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorScrollView.h`
...
## Conversion Notes
- Write the converted source into `src/ProjectWindow/qtractorScrollView.h` or the closest package-local equivalent once the package manifest is updated.
