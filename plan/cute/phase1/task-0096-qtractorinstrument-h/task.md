# Task: Convert `qtractorInstrument.h` to U++
# Status: DONE

## Objective
Manually read `tmp/q/src/qtractorInstrument.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorInstrument.h`
...
## Conversion Notes
- Write the converted source into `src/MIDI/qtractorInstrument.h` or the closest package-local equivalent once the package manifest is updated.
