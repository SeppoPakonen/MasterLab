# Task: Convert `qtractorInstrumentMenu.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/q/src/qtractorInstrumentMenu.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorInstrumentMenu.cpp`
...
## Conversion Notes
- Write the converted source into `src/MIDI/qtractorInstrumentMenu.cpp` or the closest package-local equivalent once the package manifest is updated.
