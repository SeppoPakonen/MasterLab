# Task: Convert `qtractorVst3Plugin.h` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorVst3Plugin.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorVst3Plugin.h`
...
## Conversion Notes
- Write the converted source into `src/VSTHost/qtractorVst3Plugin.h` or the closest package-local equivalent once the package manifest is updated.
