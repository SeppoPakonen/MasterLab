# Task: Convert `qtractorFileList.h` to U++
# Status: DONE

## Objective
Manually read `tmp/q/src/qtractorFileList.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorFileList.h`
...
## Conversion Notes
- Write the converted source into `src/FileIO/qtractorFileList.h` or the closest package-local equivalent once the package manifest is updated.
