# Task: Convert `qtractorTempoAdjustForm.ui` to U++
# Status: DONE

## Objective
Manually read `tmp/q/src/qtractorTempoAdjustForm.ui` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorTempoAdjustForm.ui`
...
## Conversion Notes
- Convert the form into a U++ layout/control implementation associated with `src/AudioEditing`.
