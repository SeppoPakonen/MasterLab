# Task: Convert `qtractorMidiEventList.h` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorMidiEventList.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorMidiEventList.h`
...
## Conversion Notes
- Write the converted source into `src/MIDI/qtractorMidiEventList.h` or the closest package-local equivalent once the package manifest is updated.
