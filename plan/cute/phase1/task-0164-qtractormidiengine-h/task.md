# Task: Convert `qtractorMidiEngine.h` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorMidiEngine.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorMidiEngine.h`
...
## Conversion Notes
- Write the converted source into `src/MIDI/qtractorMidiEngine.h` or the closest package-local equivalent once the package manifest is updated.
