# Task: Convert `qtractorEditRangeForm.h` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorEditRangeForm.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorEditRangeForm.h`
...
## Conversion Notes
- Write the converted source into `src/AudioEditing/qtractorEditRangeForm.h` or the closest package-local equivalent once the package manifest is updated.
