# Task: Convert `qtractorTrackView.h` to U++
# Status: DONE

## Objective
Manually read `tmp/q/src/qtractorTrackView.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorTrackView.h`
...
## Conversion Notes
- Write the converted source into `src/ProjectWindow/qtractorTrackView.h` or the closest package-local equivalent once the package manifest is updated.
