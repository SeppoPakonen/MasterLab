# Task: Convert `qtractorInstrumentForm.h` to U++
# Status: DONE

## Objective
Manually read `tmp/q/src/qtractorInstrumentForm.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorInstrumentForm.h`
...
## Conversion Notes
- Write the converted source into `src/MIDI/qtractorInstrumentForm.h` or the closest package-local equivalent once the package manifest is updated.
