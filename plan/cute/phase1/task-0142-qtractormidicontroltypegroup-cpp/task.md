# Task: Convert `qtractorMidiControlTypeGroup.cpp` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorMidiControlTypeGroup.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorMidiControlTypeGroup.cpp`
...
## Conversion Notes
- Write the converted source into `src/MIDI/qtractorMidiControlTypeGroup.cpp` or the closest package-local equivalent once the package manifest is updated.
