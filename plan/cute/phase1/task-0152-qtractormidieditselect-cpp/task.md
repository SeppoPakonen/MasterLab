# Task: Convert `qtractorMidiEditSelect.cpp` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorMidiEditSelect.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorMidiEditSelect.cpp`
...
## Conversion Notes
- Write the converted source into `src/MIDI/qtractorMidiEditSelect.cpp` or the closest package-local equivalent once the package manifest is updated.
