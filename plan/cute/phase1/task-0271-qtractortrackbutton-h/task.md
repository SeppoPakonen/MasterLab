# Task: Convert `qtractorTrackButton.h` to U++
# Status: DONE

## Objective
Manually read `tmp/q/src/qtractorTrackButton.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorTrackButton.h`
...
## Conversion Notes
- Write the converted source into `src/ProjectWindow/qtractorTrackButton.h` or the closest package-local equivalent once the package manifest is updated.
