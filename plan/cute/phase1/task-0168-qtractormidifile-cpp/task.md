# Task: Convert `qtractorMidiFile.cpp` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorMidiFile.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorMidiFile.cpp`
...
## Conversion Notes
- Write the converted source into `src/MIDI/qtractorMidiFile.cpp` or the closest package-local equivalent once the package manifest is updated.
