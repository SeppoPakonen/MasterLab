# Task: Convert `qtractorMidiCursor.h` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorMidiCursor.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorMidiCursor.h`
...
## Conversion Notes
- Write the converted source into `src/MIDI/qtractorMidiCursor.h` or the closest package-local equivalent once the package manifest is updated.
