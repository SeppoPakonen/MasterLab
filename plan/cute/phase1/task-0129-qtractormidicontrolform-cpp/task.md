# Task: Convert `qtractorMidiControlForm.cpp` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorMidiControlForm.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorMidiControlForm.cpp`
...
## Conversion Notes
- Write the converted source into `src/MIDI/qtractorMidiControlForm.cpp` or the closest package-local equivalent once the package manifest is updated.
