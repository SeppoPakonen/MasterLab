# Task: Convert `qtractorSession.cpp` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorSession.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorSession.cpp`
...
## Conversion Notes
- Write the converted source into `src/AudioCore/qtractorSession.cpp` or the closest package-local equivalent once the package manifest is updated.
