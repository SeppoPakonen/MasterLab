# Task: Convert `qtractorPasteRepeatForm.ui` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorPasteRepeatForm.ui` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorPasteRepeatForm.ui`
