# Task: Convert `qtractorAudioVorbisFile.cpp` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorAudioVorbisFile.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorAudioVorbisFile.cpp`
...
## Conversion Notes
- Write the converted source into `src/AudioCore/qtractorAudioVorbisFile.cpp` or the closest package-local equivalent once the package manifest is updated.
