# Task: Convert `qtractorInsertPlugin.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/q/src/qtractorInsertPlugin.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorInsertPlugin.cpp`
...
## Conversion Notes
- Write the converted source into `src/VSTHost/qtractorInsertPlugin.cpp` or the closest package-local equivalent once the package manifest is updated.
