# Task: Convert `qtractorSessionForm.h` to U++
# Status: DONE

## Objective
Manually read `tmp/q/src/qtractorSessionForm.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorSessionForm.h`
...
## Conversion Notes
- Write the converted source into `src/AudioCore/qtractorSessionForm.h` or the closest package-local equivalent once the package manifest is updated.
