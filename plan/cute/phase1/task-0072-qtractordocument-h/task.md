# Task: Convert `qtractorDocument.h` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorDocument.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorDocument.h`
...
## Conversion Notes
- Write the converted source into `src/FileIO/qtractorDocument.h` or the closest package-local equivalent once the package manifest is updated.
