# Task: Convert `qtractorVst2Plugin.cpp` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorVst2Plugin.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorVst2Plugin.cpp`
...
## Conversion Notes
- Write the converted source into `src/VSTHost/qtractorVst2Plugin.cpp` or the closest package-local equivalent once the package manifest is updated.
