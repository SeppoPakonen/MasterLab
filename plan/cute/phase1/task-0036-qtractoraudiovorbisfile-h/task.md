# Task: Convert `qtractorAudioVorbisFile.h` to U++
# Status: DONE

## Objective
Manually read `tmp/q/src/qtractorAudioVorbisFile.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorAudioVorbisFile.h`
...
## Conversion Notes
- Write the converted source into `src/AudioCore/qtractorAudioVorbisFile.h` or the closest package-local equivalent once the package manifest is updated.
