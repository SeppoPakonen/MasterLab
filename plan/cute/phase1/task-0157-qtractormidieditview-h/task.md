# Task: Convert `qtractorMidiEditView.h` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorMidiEditView.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorMidiEditView.h`
...
## Conversion Notes
- Write the converted source into `src/MIDI/qtractorMidiEditView.h` or the closest package-local equivalent once the package manifest is updated.
