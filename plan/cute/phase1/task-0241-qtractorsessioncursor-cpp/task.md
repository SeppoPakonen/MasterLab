# Task: Convert `qtractorSessionCursor.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/q/src/qtractorSessionCursor.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorSessionCursor.cpp`
...
## Conversion Notes
- Write the converted source into `src/AudioCore/qtractorSessionCursor.cpp` or the closest package-local equivalent once the package manifest is updated.
