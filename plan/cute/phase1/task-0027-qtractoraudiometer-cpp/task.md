# Task: Convert `qtractorAudioMeter.cpp` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorAudioMeter.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorAudioMeter.cpp`
...
## Conversion Notes
- Write the converted source into `src/AudioCore/qtractorAudioMeter.cpp` or the closest package-local equivalent once the package manifest is updated.
