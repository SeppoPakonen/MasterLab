# Task: Convert `qtractorTrackList.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/q/src/qtractorTrackList.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorTrackList.cpp`
...
## Conversion Notes
- Write the converted source into `src/ProjectWindow/qtractorTrackList.cpp` or the closest package-local equivalent once the package manifest is updated.
