...
## Conversion Notes
- Write the converted source into `src/TransportUI/qtractorTimeScale.h` or the closest package-local equivalent once the package manifest is updated.
