# Task: Convert `qtractorFiles.h` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorFiles.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorFiles.h`
...
## Conversion Notes
- Write the converted source into `src/FileIO/qtractorFiles.h` or the closest package-local equivalent once the package manifest is updated.
