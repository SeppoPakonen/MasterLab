# Task: Convert `qtractorLadspaPlugin.h` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorLadspaPlugin.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorLadspaPlugin.h`
...
## Conversion Notes
- Write the converted source into `src/VSTHost/qtractorLadspaPlugin.h` or the closest package-local equivalent once the package manifest is updated.
