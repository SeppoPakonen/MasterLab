# Task: Convert `qtractorMidiClip.cpp` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorMidiClip.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorMidiClip.cpp`
...
## Conversion Notes
- Write the converted source into `src/MIDI/qtractorMidiClip.cpp` or the closest package-local equivalent once the package manifest is updated.
