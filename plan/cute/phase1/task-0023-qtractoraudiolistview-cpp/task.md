# Task: Convert `qtractorAudioListView.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/q/src/qtractorAudioListView.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorAudioListView.cpp`

## Target
- Cute assembly anchor: `src/Cute`
- Suggested package: `Browser`
- Suggested output root: `src/Browser`
- Package rationale: Media/file browser list controls.

## Conversion Notes
- Write the converted source into `src/Browser/qtractorAudioListView.cpp` or the closest package-local equivalent once the package manifest is updated.
