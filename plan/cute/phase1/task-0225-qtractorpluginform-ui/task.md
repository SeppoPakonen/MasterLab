# Task: Convert `qtractorPluginForm.ui` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorPluginForm.ui` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorPluginForm.ui`
