# Task: Convert `qtractorMidiEditList.h` to U++
# Status: DONE

## Objective
Manually read `tmp/q/src/qtractorMidiEditList.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorMidiEditList.h`
...
## Conversion Notes
- Write the converted source into `src/MIDI/qtractorMidiEditList.h` or the closest package-local equivalent once the package manifest is updated.
