# Task: Convert `qtractorInsertPlugin.h` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorInsertPlugin.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorInsertPlugin.h`
...
## Conversion Notes
- Write the converted source into `src/VSTHost/qtractorInsertPlugin.h` or the closest package-local equivalent once the package manifest is updated.
