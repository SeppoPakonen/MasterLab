# Task: Convert `qtractorEngine.h` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorEngine.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorEngine.h`
...
## Conversion Notes
- Write the converted source into `src/AudioCore/qtractorEngine.h` or the closest package-local equivalent once the package manifest is updated.
