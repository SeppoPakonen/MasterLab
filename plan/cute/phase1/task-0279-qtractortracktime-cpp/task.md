# Task: Convert `qtractorTrackTime.cpp` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorTrackTime.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorTrackTime.cpp`
...
## Conversion Notes
- Write the converted source into `src/ProjectWindow/qtractorTrackTime.cpp` or the closest package-local equivalent once the package manifest is updated.
