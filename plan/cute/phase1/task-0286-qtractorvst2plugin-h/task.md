# Task: Convert `qtractorVst2Plugin.h` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorVst2Plugin.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorVst2Plugin.h`
...
## Conversion Notes
- Write the converted source into `src/VSTHost/qtractorVst2Plugin.h` or the closest package-local equivalent once the package manifest is updated.
