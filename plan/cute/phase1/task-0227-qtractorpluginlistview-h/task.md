# Task: Convert `qtractorPluginListView.h` to U++
# Status: DONE

## Objective
Manually read `tmp/q/src/qtractorPluginListView.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorPluginListView.h`
...
## Conversion Notes
- Write the converted source into `src/VSTHost/qtractorPluginListView.h` or the closest package-local equivalent once the package manifest is updated.
