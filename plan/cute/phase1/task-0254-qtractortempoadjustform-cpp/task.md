...
## Source
- `tmp/q/src/qtractorTempoAdjustForm.cpp`
...
## Conversion Notes
- Write the converted source into `src/AudioEditing/qtractorTempoAdjustForm.cpp` or the closest package-local equivalent once the package manifest is updated.
