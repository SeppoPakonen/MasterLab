# Task: Convert `qtractorMidiEditSelect.h` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorMidiEditSelect.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorMidiEditSelect.h`
...
## Conversion Notes
- Write the converted source into `src/MIDI/qtractorMidiEditSelect.h` or the closest package-local equivalent once the package manifest is updated.
