...
## Objective
Manually read `tmp/q/src/CMakeLists.txt` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/CMakeLists.txt`
...
## Output
- `src/Cute/AGENTS.md`
- `src/Cute/CMakeListsConversion.md`
