# Task: Convert `qtractorSessionCommand.h` to U++
# Status: DONE

## Objective
Manually read `tmp/q/src/qtractorSessionCommand.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorSessionCommand.h`
...
## Conversion Notes
- Write the converted source into `src/ProjectMgmt/qtractorSessionCommand.h` or the closest package-local equivalent once the package manifest is updated.
