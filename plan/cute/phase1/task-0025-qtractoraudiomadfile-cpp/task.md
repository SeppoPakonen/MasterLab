# Task: Convert `qtractorAudioMadFile.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/q/src/qtractorAudioMadFile.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorAudioMadFile.cpp`
...
## Conversion Notes
- Write the converted source into `src/AudioCore/qtractorAudioMadFile.cpp` or the closest package-local equivalent once the package manifest is updated.
