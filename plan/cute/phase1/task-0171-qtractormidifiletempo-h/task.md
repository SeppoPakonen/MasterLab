# Task: Convert `qtractorMidiFileTempo.h` to U++
# Status: DONE

## Objective
Manually read `tmp/q/src/qtractorMidiFileTempo.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorMidiFileTempo.h`
...
## Conversion Notes
- Write the converted source into `src/MIDI/qtractorMidiFileTempo.h` or the closest package-local equivalent once the package manifest is updated.
