# Task: Convert `qtractorEditRangeForm.ui` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorEditRangeForm.ui` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorEditRangeForm.ui`
