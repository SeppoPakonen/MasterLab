# Task: Convert `qtractorMidiEditList.cpp` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorMidiEditList.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorMidiEditList.cpp`
...
## Conversion Notes
- Write the converted source into `src/MIDI/qtractorMidiEditList.cpp` or the closest package-local equivalent once the package manifest is updated.
