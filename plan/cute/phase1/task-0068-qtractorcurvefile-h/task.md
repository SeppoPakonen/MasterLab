# Task: Convert `qtractorCurveFile.h` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorCurveFile.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorCurveFile.h`
...
## Conversion Notes
- Write the converted source into `src/AudioCore/qtractorCurveFile.h` or the closest package-local equivalent once the package manifest is updated.
