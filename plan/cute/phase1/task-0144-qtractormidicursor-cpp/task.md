# Task: Convert `qtractorMidiCursor.cpp` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorMidiCursor.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorMidiCursor.cpp`
...
## Conversion Notes
- Write the converted source into `src/MIDI/qtractorMidiCursor.cpp` or the closest package-local equivalent once the package manifest is updated.
