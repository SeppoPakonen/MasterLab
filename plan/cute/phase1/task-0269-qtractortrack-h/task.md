...
## Conversion Notes
- Write the converted source into `src/ProjectWindow/qtractorTrack.h` or the closest package-local equivalent once the package manifest is updated.
