# Task: Convert `qtractorTakeRangeForm.h` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorTakeRangeForm.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorTakeRangeForm.h`
...
## Conversion Notes
- Write the converted source into `src/ProjectWindow/qtractorTakeRangeForm.h` or the closest package-local equivalent once the package manifest is updated.
