# Task: Convert `qtractorMidiControlCommand.h` to U++
# Status: DONE

## Objective
Manually read `tmp/q/src/qtractorMidiControlCommand.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorMidiControlCommand.h`
...
## Conversion Notes
- Write the converted source into `src/ProjectMgmt/qtractorMidiControlCommand.h` or the closest package-local equivalent once the package manifest is updated.
