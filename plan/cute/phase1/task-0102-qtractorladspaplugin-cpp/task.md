# Task: Convert `qtractorLadspaPlugin.cpp` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorLadspaPlugin.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorLadspaPlugin.cpp`
...
## Conversion Notes
- Write the converted source into `src/VSTHost/qtractorLadspaPlugin.cpp` or the closest package-local equivalent once the package manifest is updated.
