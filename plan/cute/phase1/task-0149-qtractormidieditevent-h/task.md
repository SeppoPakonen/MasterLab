# Task: Convert `qtractorMidiEditEvent.h` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorMidiEditEvent.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorMidiEditEvent.h`
...
## Conversion Notes
- Write the converted source into `src/MIDI/qtractorMidiEditEvent.h` or the closest package-local equivalent once the package manifest is updated.
