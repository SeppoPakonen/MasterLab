# Task: Convert `qtractorSessionForm.cpp` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorSessionForm.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorSessionForm.cpp`
...
## Conversion Notes
- Write the converted source into `src/AudioCore/qtractorSessionForm.cpp` or the closest package-local equivalent once the package manifest is updated.
