# Task: Convert `qtractorClipSelect.h` to U++
# Status: DONE

## Objective
Manually read `tmp/q/src/qtractorClipSelect.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorClipSelect.h`
...
## Conversion Notes
- Write the converted source into `src/AudioEditing/qtractorClipSelect.h` or the closest package-local equivalent once the package manifest is updated.
