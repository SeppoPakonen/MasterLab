# Task: Convert `qtractorTracks.h` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorTracks.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorTracks.h`
...
## Conversion Notes
- Write the converted source into `src/ProjectWindow/qtractorTracks.h` or the closest package-local equivalent once the package manifest is updated.
