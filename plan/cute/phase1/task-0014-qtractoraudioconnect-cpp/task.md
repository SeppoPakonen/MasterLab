...
## Source
- `tmp/q/src/qtractorAudioConnect.cpp`
...
## Conversion Notes
- Write the converted source into `src/Devices/qtractorAudioConnect.cpp` or the closest package-local equivalent once the package manifest is updated.
