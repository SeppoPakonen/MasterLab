# Task: Convert `qtractorMmcEvent.cpp` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorMmcEvent.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorMmcEvent.cpp`
...
## Conversion Notes
- Write the converted source into `src/MIDI/qtractorMmcEvent.cpp` or the closest package-local equivalent once the package manifest is updated.
