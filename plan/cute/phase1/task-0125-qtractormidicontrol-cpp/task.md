# Task: Convert `qtractorMidiControl.cpp` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorMidiControl.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorMidiControl.cpp`
...
## Conversion Notes
- Write the converted source into `src/MIDI/qtractorMidiControl.cpp` or the closest package-local equivalent once the package manifest is updated.
