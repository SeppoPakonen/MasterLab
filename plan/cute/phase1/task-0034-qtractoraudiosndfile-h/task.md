# Task: Convert `qtractorAudioSndFile.h` to U++
# Status: DONE

## Objective
Manually read `tmp/q/src/qtractorAudioSndFile.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorAudioSndFile.h`
...
## Conversion Notes
- Write the converted source into `src/AudioCore/qtractorAudioSndFile.h` or the closest package-local equivalent once the package manifest is updated.
