# Task: Convert `qtractorMidiEditTime.h` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorMidiEditTime.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorMidiEditTime.h`
...
## Conversion Notes
- Write the converted source into `src/MIDI/qtractorMidiEditTime.h` or the closest package-local equivalent once the package manifest is updated.
