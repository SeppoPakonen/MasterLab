# Task: Convert `qtractorMessageBox.h` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorMessageBox.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorMessageBox.h`
...
## Conversion Notes
- Write the converted source into `src/AudioMaster/qtractorMessageBox.h` or the closest package-local equivalent once the package manifest is updated.
