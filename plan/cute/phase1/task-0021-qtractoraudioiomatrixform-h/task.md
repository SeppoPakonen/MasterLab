# Task: Convert `qtractorAudioIOMatrixForm.h` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorAudioIOMatrixForm.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorAudioIOMatrixForm.h`
...
## Conversion Notes
- Write the converted source into `src/VSTConnections/qtractorAudioIOMatrixForm.h` or the closest package-local equivalent once the package manifest is updated.
