# Task: Convert `qtractorBusForm.ui` to U++
# Status: DONE

## Objective
Manually read `tmp/q/src/qtractorBusForm.ui` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorBusForm.ui`
