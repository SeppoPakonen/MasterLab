# Task: Convert `qtractorTrackCommand.cpp` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorTrackCommand.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorTrackCommand.cpp`
...
## Conversion Notes
- Write the converted source into `src/ProjectMgmt/qtractorTrackCommand.cpp` or the closest package-local equivalent once the package manifest is updated.
