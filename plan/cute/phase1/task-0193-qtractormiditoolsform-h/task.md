# Task: Convert `qtractorMidiToolsForm.h` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorMidiToolsForm.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorMidiToolsForm.h`
...
## Conversion Notes
- Write the converted source into `src/MIDI/qtractorMidiToolsForm.h` or the closest package-local equivalent once the package manifest is updated.
