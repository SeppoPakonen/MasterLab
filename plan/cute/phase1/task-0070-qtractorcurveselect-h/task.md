# Task: Convert `qtractorCurveSelect.h` to U++
# Status: DONE

## Objective
Manually read `tmp/q/src/qtractorCurveSelect.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorCurveSelect.h`
...
## Conversion Notes
- Write the converted source into `src/AudioEditing/qtractorCurveSelect.h` or the closest package-local equivalent once the package manifest is updated.
