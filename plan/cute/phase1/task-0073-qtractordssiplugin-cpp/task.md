# Task: Convert `qtractorDssiPlugin.cpp` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorDssiPlugin.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorDssiPlugin.cpp`
...
## Conversion Notes
- Write the converted source into `src/VSTHost/qtractorDssiPlugin.cpp` or the closest package-local equivalent once the package manifest is updated.
