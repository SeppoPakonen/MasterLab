# Task: Convert `qtractorTakeRangeForm.ui` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorTakeRangeForm.ui` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorTakeRangeForm.ui`
