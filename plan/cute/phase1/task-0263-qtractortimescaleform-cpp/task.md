# Task: Convert `qtractorTimeScaleForm.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/q/src/qtractorTimeScaleForm.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorTimeScaleForm.cpp`
...
## Conversion Notes
- Write the converted source into `src/TransportUI/qtractorTimeScaleForm.cpp` or the closest package-local equivalent once the package manifest is updated.
