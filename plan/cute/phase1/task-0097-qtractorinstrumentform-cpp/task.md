# Task: Convert `qtractorInstrumentForm.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/q/src/qtractorInstrumentForm.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorInstrumentForm.cpp`
...
## Conversion Notes
- Write the converted source into `src/MIDI/qtractorInstrumentForm.cpp` or the closest package-local equivalent once the package manifest is updated.
