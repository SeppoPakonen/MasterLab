# Task: Convert `qtractorTrackTime.h` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorTrackTime.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorTrackTime.h`
...
## Conversion Notes
- Write the converted source into `src/ProjectWindow/qtractorTrackTime.h` or the closest package-local equivalent once the package manifest is updated.
