# Task: Convert `qtractorSessionForm.ui` to U++
# Status: TODO

## Objective
Manually read `tmp/q/src/qtractorSessionForm.ui` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/q/src/qtractorSessionForm.ui`
...
## Conversion Notes
- Convert the form into a U++ layout/control implementation associated with `src/AudioCore`.
