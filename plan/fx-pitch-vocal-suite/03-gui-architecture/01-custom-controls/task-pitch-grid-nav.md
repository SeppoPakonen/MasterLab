...
1.  **Implement Pitch-to-Y Mapping:** [DONE]
...
2.  **Implement Time-to-X Mapping:** [DONE]
...
4.  **Interactive Zoom/Scroll:** [DONE]
...
1.  A musical pitch grid is visible in the `PitchGraphEditor`. [DONE]
2.  Detected pitch points are correctly mapped to their musical pitch on the Y-axis. [DONE]
3.  The view can be scrolled horizontally, and the `WaveformStrip` stays in sync. [DONE]
