# Task: Convert `otio/otioutil.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/otio/otioutil.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/otio/otioutil.cpp`
