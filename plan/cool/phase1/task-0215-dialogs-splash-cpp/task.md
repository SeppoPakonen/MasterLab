# Task: Convert `dialogs/splash.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/dialogs/splash.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/dialogs/splash.cpp`
