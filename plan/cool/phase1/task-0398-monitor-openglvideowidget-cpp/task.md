# Task: Convert `monitor/openglvideowidget.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/monitor/openglvideowidget.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/monitor/openglvideowidget.cpp`
...
## Output
- `src/Cool/monitor/Openglvideowidget.cpp`
