# Task: Convert `project/effectsettings.h` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/project/effectsettings.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/project/effectsettings.h`
...
## Output
- `src/Cool/project/Effectsettings.h`
