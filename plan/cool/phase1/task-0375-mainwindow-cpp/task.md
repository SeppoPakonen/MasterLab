# Task: Convert `mainwindow.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/mainwindow.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/mainwindow.cpp`
