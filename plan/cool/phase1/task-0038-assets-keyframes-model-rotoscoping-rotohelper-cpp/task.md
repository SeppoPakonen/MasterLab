# Task: Convert `assets/keyframes/model/rotoscoping/rotohelper.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/keyframes/model/rotoscoping/rotohelper.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/keyframes/model/rotoscoping/rotohelper.cpp`
...
## Output
- `src/Cool/assets/keyframes/model/rotoscoping/Rotohelper.cpp`
