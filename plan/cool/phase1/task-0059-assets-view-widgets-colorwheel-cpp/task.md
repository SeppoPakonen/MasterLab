# Task: Convert `assets/view/widgets/colorwheel.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/view/widgets/colorwheel.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/view/widgets/colorwheel.cpp`
...
## Output
- `src/Cool/assets/view/widgets/Colorwheel.cpp`
