# Task: Convert `assets/keyframes/model/rect/rotatedrecthelper.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/keyframes/model/rect/rotatedrecthelper.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/keyframes/model/rect/rotatedrecthelper.cpp`
...
## Output
- `src/Cool/assets/keyframes/model/rect/Rotatedrecthelper.cpp`
