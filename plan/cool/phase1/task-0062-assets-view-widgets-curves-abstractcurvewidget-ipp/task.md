# Task: Convert `assets/view/widgets/curves/abstractcurvewidget.ipp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/view/widgets/curves/abstractcurvewidget.ipp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/view/widgets/curves/abstractcurvewidget.ipp`
...
## Output
- `src/Cool/assets/view/widgets/curves/Abstractcurvewidget.ipp`
