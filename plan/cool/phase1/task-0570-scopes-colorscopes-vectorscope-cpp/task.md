# Task: Convert `scopes/colorscopes/vectorscope.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/scopes/colorscopes/vectorscope.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/scopes/colorscopes/vectorscope.cpp`
...
## Output
- `src/Cool/scopes/colorscopes/Vectorscope.cpp`
