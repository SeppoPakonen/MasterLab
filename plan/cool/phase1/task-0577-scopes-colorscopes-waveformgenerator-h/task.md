# Task: Convert `scopes/colorscopes/waveformgenerator.h` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/scopes/colorscopes/waveformgenerator.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/scopes/colorscopes/waveformgenerator.h`
...
## Output
- `src/Cool/scopes/colorscopes/Waveformgenerator.h`
