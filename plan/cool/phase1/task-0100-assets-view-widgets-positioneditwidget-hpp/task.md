# Task: Convert `assets/view/widgets/positioneditwidget.hpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/view/widgets/positioneditwidget.hpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/view/widgets/positioneditwidget.hpp`
...
## Output
- `src/Cool/assets/view/widgets/Positioneditwidget.hpp`
