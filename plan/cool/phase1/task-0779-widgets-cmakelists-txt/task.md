# Task: Convert `widgets/CMakeLists.txt` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/widgets/CMakeLists.txt` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/widgets/CMakeLists.txt`
...
## Output
- `src/Cool/widgets/CMakeListsConversion.md`
