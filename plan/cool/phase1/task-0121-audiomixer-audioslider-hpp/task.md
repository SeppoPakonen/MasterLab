# Task: Convert `audiomixer/audioslider.hpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/audiomixer/audioslider.hpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/audiomixer/audioslider.hpp`
...
## Output
- `src/Cool/audiomixer/Audioslider.hpp`
