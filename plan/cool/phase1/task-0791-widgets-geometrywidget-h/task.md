# Task: Convert `widgets/geometrywidget.h` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/widgets/geometrywidget.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/widgets/geometrywidget.h`
...
## Output
- `src/Cool/widgets/Geometrywidget.h`
