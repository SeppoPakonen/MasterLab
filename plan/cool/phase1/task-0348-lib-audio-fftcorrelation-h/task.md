# Task: Convert `lib/audio/fftCorrelation.h` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/lib/audio/fftCorrelation.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/lib/audio/fftCorrelation.h`
...
## Output
- `src/Cool/lib/audio/FftCorrelation.h`
