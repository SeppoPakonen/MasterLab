# Task: Convert `monitor/metalvideowidget.mm` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/monitor/metalvideowidget.mm` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/monitor/metalvideowidget.mm`
...
## Output
- `src/Cool/monitor/Metalvideowidget.mm`
