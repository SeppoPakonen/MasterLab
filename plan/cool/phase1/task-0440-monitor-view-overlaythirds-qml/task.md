# Task: Convert `monitor/view/OverlayThirds.qml` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/monitor/view/OverlayThirds.qml` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/monitor/view/OverlayThirds.qml`
...
## Output
- `src/Cool/monitor/view/OverlayThirdsConversion.md`
