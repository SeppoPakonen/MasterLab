# Task: Convert `layouts/layoutinfo.h` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/layouts/layoutinfo.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/layouts/layoutinfo.h`
