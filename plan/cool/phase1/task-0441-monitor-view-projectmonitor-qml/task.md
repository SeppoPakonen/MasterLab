# Task: Convert `monitor/view/ProjectMonitor.qml` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/monitor/view/ProjectMonitor.qml` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/monitor/view/ProjectMonitor.qml`
...
## Output
- `src/Cool/monitor/view/ProjectMonitorConversion.md`
