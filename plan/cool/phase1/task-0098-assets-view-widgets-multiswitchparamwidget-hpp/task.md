# Task: Convert `assets/view/widgets/multiswitchparamwidget.hpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/view/widgets/multiswitchparamwidget.hpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/view/widgets/multiswitchparamwidget.hpp`
...
## Output
- `src/Cool/assets/view/widgets/Multiswitchparamwidget.hpp`
