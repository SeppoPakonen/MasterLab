# Task: Convert `jogshuttle/jogaction.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/jogshuttle/jogaction.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/jogshuttle/jogaction.cpp`
...
## Output
- `src/Cool/jogshuttle/Jogaction.cpp`
