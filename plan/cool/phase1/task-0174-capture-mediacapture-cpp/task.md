# Task: Convert `capture/mediacapture.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/capture/mediacapture.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/capture/mediacapture.cpp`
...
## Output
- `src/Cool/capture/Mediacapture.cpp`
