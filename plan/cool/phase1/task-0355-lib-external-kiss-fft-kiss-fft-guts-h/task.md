# Task: Convert `lib/external/kiss_fft/_kiss_fft_guts.h` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/lib/external/kiss_fft/_kiss_fft_guts.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/lib/external/kiss_fft/_kiss_fft_guts.h`
...
## Output
- `src/Cool/lib/external/kiss_fft/KissFftGuts.h`
