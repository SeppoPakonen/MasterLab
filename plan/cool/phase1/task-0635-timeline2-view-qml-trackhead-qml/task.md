# Task: Convert `timeline2/view/qml/TrackHead.qml` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/timeline2/view/qml/TrackHead.qml` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/timeline2/view/qml/TrackHead.qml`
...
## Output
- `src/Cool/timeline2/view/qml/TrackHeadConversion.md`
