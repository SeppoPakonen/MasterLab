# Task: Convert `assets/view/widgets/positioneditwidget.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/view/widgets/positioneditwidget.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/view/widgets/positioneditwidget.cpp`
...
## Output
- `src/Cool/assets/view/widgets/Positioneditwidget.cpp`
