# Task: Convert `effects/effectstack/view/abstractcollapsiblewidget.h` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/effects/effectstack/view/abstractcollapsiblewidget.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/effects/effectstack/view/abstractcollapsiblewidget.h`
...
## Output
- `src/Cool/effects/effectstack/view/Abstractcollapsiblewidget.h`
