# Task: Convert `logger.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/logger.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/logger.cpp`
