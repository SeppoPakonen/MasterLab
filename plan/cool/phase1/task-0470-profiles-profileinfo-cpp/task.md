# Task: Convert `profiles/profileinfo.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/profiles/profileinfo.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/profiles/profileinfo.cpp`
...
## Output
- `src/Cool/profiles/Profileinfo.cpp`
