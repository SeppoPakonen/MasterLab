# Task: Convert `pythoninterfaces/otioconvertions.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/pythoninterfaces/otioconvertions.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/pythoninterfaces/otioconvertions.cpp`
...
## Output
- `src/Cool/pythoninterfaces/Otioconvertions.cpp`
