# Task: Convert `bin/projectsubclip.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/bin/projectsubclip.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/bin/projectsubclip.cpp`
...
## Output
- `src/Cool/bin/Projectsubclip.cpp`
