# Task: Convert `layouts/CMakeLists.txt` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/layouts/CMakeLists.txt` and convert it into MasterLab U++ conventions without attempting to compile.
