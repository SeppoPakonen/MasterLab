# Task: Convert `jobs/stabilizetask.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/jobs/stabilizetask.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/jobs/stabilizetask.cpp`
...
## Output
- `src/Cool/jobs/Stabilizetask.cpp`
