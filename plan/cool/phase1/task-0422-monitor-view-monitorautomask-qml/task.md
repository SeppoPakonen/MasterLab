# Task: Convert `monitor/view/MonitorAutomask.qml` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/monitor/view/MonitorAutomask.qml` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/monitor/view/MonitorAutomask.qml`
...
## Output
- `src/Cool/monitor/view/MonitorAutomaskConversion.md`
