# Task: Convert `lib/external/kiss_fft/kiss_fftr.c` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/lib/external/kiss_fft/kiss_fftr.c` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/lib/external/kiss_fft/kiss_fftr.c`
...
## Output
- `src/Cool/lib/external/kiss_fft/KissFftr.cpppp`
