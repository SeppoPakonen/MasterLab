# Task: Convert `lib/audio/audioCorrelation.h` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/lib/audio/audioCorrelation.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/lib/audio/audioCorrelation.h`
...
## Output
- `src/Cool/lib/audio/AudioCorrelation.h`
