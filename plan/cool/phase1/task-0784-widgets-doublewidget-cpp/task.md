# Task: Convert `widgets/doublewidget.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/widgets/doublewidget.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/widgets/doublewidget.cpp`
...
## Output
- `src/Cool/widgets/Doublewidget.cpp`
