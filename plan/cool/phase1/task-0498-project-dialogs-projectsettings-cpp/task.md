# Task: Convert `project/dialogs/projectsettings.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/project/dialogs/projectsettings.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/project/dialogs/projectsettings.cpp`
...
## Output
- `src/Cool/project/dialogs/Projectsettings.cpp`
