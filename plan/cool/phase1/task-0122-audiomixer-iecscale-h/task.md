# Task: Convert `audiomixer/iecscale.h` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/audiomixer/iecscale.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/audiomixer/iecscale.h`
...
## Output
- `src/Cool/audiomixer/Iecscale.h`
