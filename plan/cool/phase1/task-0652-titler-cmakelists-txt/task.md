# Task: Convert `titler/CMakeLists.txt` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/titler/CMakeLists.txt` and convert it into MasterLab U++ conventions without attempting to compile.
