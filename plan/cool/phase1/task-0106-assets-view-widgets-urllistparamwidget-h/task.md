# Task: Convert `assets/view/widgets/urllistparamwidget.h` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/view/widgets/urllistparamwidget.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/view/widgets/urllistparamwidget.h`
...
## Output
- `src/Cool/assets/view/widgets/Urllistparamwidget.h`
