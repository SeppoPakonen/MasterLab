# Task: Convert `onlineresources/resourcewidget.hpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/onlineresources/resourcewidget.hpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/onlineresources/resourcewidget.hpp`
...
## Output
- `src/Cool/onlineresources/Resourcewidget.hpp`
