# Task: Convert `macros.hpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/macros.hpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/macros.hpp`
