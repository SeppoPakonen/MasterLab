# Task: Convert `lib/external/media_ctrl/CMakeLists.txt` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/lib/external/media_ctrl/CMakeLists.txt` and convert it into MasterLab U++ conventions without attempting to compile.
