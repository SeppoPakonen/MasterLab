# Task: Convert `assets/view/widgets/urlparamwidget.hpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/view/widgets/urlparamwidget.hpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/view/widgets/urlparamwidget.hpp`
...
## Output
- `src/Cool/assets/view/widgets/Urlparamwidget.hpp`
