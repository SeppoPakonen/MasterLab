# Task: Convert `filefilter.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/filefilter.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/filefilter.cpp`
