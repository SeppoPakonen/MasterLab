# Task: Convert `timeline2/view/qml/MixShape.qml` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/timeline2/view/qml/MixShape.qml` and convert it into MasterLab U++ conventions without attempting to compile.
