# Task: Convert `jobs/audiolevels/audiolevelstask.h` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/jobs/audiolevels/audiolevelstask.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/jobs/audiolevels/audiolevelstask.h`
...
## Output
- `src/Cool/jobs/audiolevels/Audiolevelstask.h`
