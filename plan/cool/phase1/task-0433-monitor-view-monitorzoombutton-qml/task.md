# Task: Convert `monitor/view/MonitorZoomButton.qml` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/monitor/view/MonitorZoomButton.qml` and convert it into MasterLab U++ conventions without attempting to compile.
