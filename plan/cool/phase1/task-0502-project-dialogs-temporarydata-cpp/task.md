# Task: Convert `project/dialogs/temporarydata.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/project/dialogs/temporarydata.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/project/dialogs/temporarydata.cpp`
...
## Output
- `src/Cool/project/dialogs/Temporarydata.cpp`
