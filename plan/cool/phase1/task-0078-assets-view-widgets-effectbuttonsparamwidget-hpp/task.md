# Task: Convert `assets/view/widgets/effectbuttonsparamwidget.hpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/view/widgets/effectbuttonsparamwidget.hpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/view/widgets/effectbuttonsparamwidget.hpp`
...
## Output
- `src/Cool/assets/view/widgets/Effectbuttonsparamwidget.hpp`
