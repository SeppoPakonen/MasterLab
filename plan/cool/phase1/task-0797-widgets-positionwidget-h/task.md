# Task: Convert `widgets/positionwidget.h` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/widgets/positionwidget.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/widgets/positionwidget.h`
...
## Output
- `src/Cool/widgets/Positionwidget.h`
