# Task: Convert `assets/view/widgets/boolparamwidget.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/view/widgets/boolparamwidget.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/view/widgets/boolparamwidget.cpp`
...
## Output
- `src/Cool/assets/view/widgets/Boolparamwidget.cpp`
