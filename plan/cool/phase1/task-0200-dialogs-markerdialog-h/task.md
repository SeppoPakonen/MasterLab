# Task: Convert `dialogs/markerdialog.h` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/dialogs/markerdialog.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/dialogs/markerdialog.h`
...
## Output
- `src/Cool/dialogs/Markerdialog.h`
