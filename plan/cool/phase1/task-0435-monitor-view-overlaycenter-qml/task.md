# Task: Convert `monitor/view/OverlayCenter.qml` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/monitor/view/OverlayCenter.qml` and convert it into MasterLab U++ conventions without attempting to compile.
