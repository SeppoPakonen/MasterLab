# Task: Convert `assets/CMakeLists.txt` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/CMakeLists.txt` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/CMakeLists.txt`
...
## Output
- `src/Cool/assets/CMakeListsConversion.md`
