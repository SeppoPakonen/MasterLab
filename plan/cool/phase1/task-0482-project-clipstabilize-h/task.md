# Task: Convert `project/clipstabilize.h` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/project/clipstabilize.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/project/clipstabilize.h`
...
## Output
- `src/Cool/project/Clipstabilize.h`
