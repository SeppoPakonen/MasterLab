# Task: Convert `CMakeLists.txt` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/CMakeLists.txt` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/CMakeLists.txt`
...
## Output
- `src/Cool/CMakeListsConversion.md`
