# Task: Convert `dialogs/wizard.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/dialogs/wizard.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/dialogs/wizard.cpp`
