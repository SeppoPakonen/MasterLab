# Task: Convert `assets/view/widgets/curves/cubic/kis_cubic_curve.h` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/view/widgets/curves/cubic/kis_cubic_curve.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/view/widgets/curves/cubic/kis_cubic_curve.h`
...
## Output
- `src/Cool/assets/view/widgets/curves/cubic/KisCubicCurve.h`
