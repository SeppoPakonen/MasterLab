# Task: Convert `effects/effectstack/model/effectgroupmodel.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/effects/effectstack/model/effectgroupmodel.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/effects/effectstack/model/effectgroupmodel.cpp`
...
## Output
- `src/Cool/effects/effectstack/model/Effectgroupmodel.cpp`
