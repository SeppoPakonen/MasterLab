# Task: Convert `project/notesplugin.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/project/notesplugin.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/project/notesplugin.cpp`
...
## Output
- `src/Cool/project/Notesplugin.cpp`
