# Task: Convert `audiomixer/audioslider.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/audiomixer/audioslider.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/audiomixer/audioslider.cpp`
...
## Output
- `src/Cool/audiomixer/Audioslider.cpp`
