# Task: Convert `utils/CMakeLists.txt` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/utils/CMakeLists.txt` and convert it into MasterLab U++ conventions without attempting to compile.
