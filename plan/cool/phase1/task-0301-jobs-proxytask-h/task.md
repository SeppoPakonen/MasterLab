# Task: Convert `jobs/proxytask.h` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/jobs/proxytask.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/jobs/proxytask.h`
