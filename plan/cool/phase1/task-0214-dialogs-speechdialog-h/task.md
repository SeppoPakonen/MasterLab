# Task: Convert `dialogs/speechdialog.h` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/dialogs/speechdialog.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/dialogs/speechdialog.h`
...
## Output
- `src/Cool/dialogs/Speechdialog.h`
