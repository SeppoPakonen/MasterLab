# Task: Convert `effects/effectstack/model/effectstackmodel.hpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/effects/effectstack/model/effectstackmodel.hpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/effects/effectstack/model/effectstackmodel.hpp`
...
## Output
- `src/Cool/effects/effectstack/model/Effectstackmodel.hpp`
