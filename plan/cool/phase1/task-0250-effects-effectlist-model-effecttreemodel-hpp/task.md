# Task: Convert `effects/effectlist/model/effecttreemodel.hpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/effects/effectlist/model/effecttreemodel.hpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/effects/effectlist/model/effecttreemodel.hpp`
...
## Output
- `src/Cool/effects/effectlist/model/Effecttreemodel.hpp`
