# Task: Convert `effects/effectlist/model/effecttreemodel.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/effects/effectlist/model/effecttreemodel.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/effects/effectlist/model/effecttreemodel.cpp`
...
## Output
- `src/Cool/effects/effectlist/model/Effecttreemodel.cpp`
