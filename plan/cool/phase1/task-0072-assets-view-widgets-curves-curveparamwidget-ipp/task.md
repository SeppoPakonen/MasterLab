# Task: Convert `assets/view/widgets/curves/curveparamwidget.ipp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/view/widgets/curves/curveparamwidget.ipp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/view/widgets/curves/curveparamwidget.ipp`
...
## Output
- `src/Cool/assets/view/widgets/curves/Curveparamwidget.ipp`
