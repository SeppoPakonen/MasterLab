# Task: Convert `xml/xml.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/xml/xml.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/xml/xml.cpp`
