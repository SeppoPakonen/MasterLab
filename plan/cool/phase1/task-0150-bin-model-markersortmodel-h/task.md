# Task: Convert `bin/model/markersortmodel.h` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/bin/model/markersortmodel.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/bin/model/markersortmodel.h`
...
## Output
- `src/Cool/bin/model/Markersortmodel.h`
