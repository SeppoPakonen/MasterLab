# Task: Convert `assets/view/widgets/geometryeditwidget.hpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/view/widgets/geometryeditwidget.hpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/view/widgets/geometryeditwidget.hpp`
...
## Output
- `src/Cool/assets/view/widgets/Geometryeditwidget.hpp`
