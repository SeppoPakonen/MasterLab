# Task: Convert `assets/view/widgets/boolparamwidget.hpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/view/widgets/boolparamwidget.hpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/view/widgets/boolparamwidget.hpp`
...
## Output
- `src/Cool/assets/view/widgets/Boolparamwidget.hpp`
