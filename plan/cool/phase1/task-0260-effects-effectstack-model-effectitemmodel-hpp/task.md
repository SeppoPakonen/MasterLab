# Task: Convert `effects/effectstack/model/effectitemmodel.hpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/effects/effectstack/model/effectitemmodel.hpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/effects/effectstack/model/effectitemmodel.hpp`
...
## Output
- `src/Cool/effects/effectstack/model/Effectitemmodel.hpp`
