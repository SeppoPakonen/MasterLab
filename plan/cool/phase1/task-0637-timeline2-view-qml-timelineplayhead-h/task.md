# Task: Convert `timeline2/view/qml/timelineplayhead.h` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/timeline2/view/qml/timelineplayhead.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/timeline2/view/qml/timelineplayhead.h`
...
## Output
- `src/Cool/timeline2/view/qml/Timelineplayhead.h`
