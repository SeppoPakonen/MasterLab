# Task: Convert `scopes/colorscopes/waveformgenerator.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/scopes/colorscopes/waveformgenerator.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/scopes/colorscopes/waveformgenerator.cpp`
...
## Output
- `src/Cool/scopes/colorscopes/Waveformgenerator.cpp`
