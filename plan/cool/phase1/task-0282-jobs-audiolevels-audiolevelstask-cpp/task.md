# Task: Convert `jobs/audiolevels/audiolevelstask.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/jobs/audiolevels/audiolevelstask.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/jobs/audiolevels/audiolevelstask.cpp`
...
## Output
- `src/Cool/jobs/audiolevels/Audiolevelstask.cpp`
