# Task: Convert `project/projectmanager.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/project/projectmanager.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/project/projectmanager.cpp`
...
## Output
- `src/Cool/project/Projectmanager.cpp`
