# Task: Convert `assets/view/widgets/geometryeditwidget.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/view/widgets/geometryeditwidget.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/view/widgets/geometryeditwidget.cpp`
...
## Output
- `src/Cool/assets/view/widgets/Geometryeditwidget.cpp`
