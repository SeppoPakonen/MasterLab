# Task: Convert `jobs/scenesplittask.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/jobs/scenesplittask.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/jobs/scenesplittask.cpp`
...
## Output
- `src/Cool/jobs/Scenesplittask.cpp`
