# Task: Convert `dialogs/markerdialog.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/dialogs/markerdialog.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/dialogs/markerdialog.cpp`
...
## Output
- `src/Cool/dialogs/Markerdialog.cpp`
