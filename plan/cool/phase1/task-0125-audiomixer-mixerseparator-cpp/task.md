# Task: Convert `audiomixer/mixerseparator.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/audiomixer/mixerseparator.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/audiomixer/mixerseparator.cpp`
...
## Output
- `src/Cool/audiomixer/Mixerseparator.cpp`
