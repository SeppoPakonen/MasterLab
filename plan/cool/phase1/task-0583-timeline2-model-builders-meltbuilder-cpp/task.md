# Task: Convert `timeline2/model/builders/meltBuilder.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/timeline2/model/builders/meltBuilder.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/timeline2/model/builders/meltBuilder.cpp`
...
## Output
- `src/Cool/timeline2/model/builders/MeltBuilder.cpp`
