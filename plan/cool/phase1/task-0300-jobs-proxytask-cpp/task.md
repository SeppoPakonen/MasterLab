# Task: Convert `jobs/proxytask.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/jobs/proxytask.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/jobs/proxytask.cpp`
