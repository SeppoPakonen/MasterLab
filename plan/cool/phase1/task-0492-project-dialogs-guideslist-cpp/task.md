# Task: Convert `project/dialogs/guideslist.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/project/dialogs/guideslist.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/project/dialogs/guideslist.cpp`
...
## Output
- `src/Cool/project/dialogs/Guideslist.cpp`
