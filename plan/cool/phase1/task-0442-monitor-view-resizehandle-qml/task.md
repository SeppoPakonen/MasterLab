# Task: Convert `monitor/view/ResizeHandle.qml` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/monitor/view/ResizeHandle.qml` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/monitor/view/ResizeHandle.qml`
...
## Output
- `src/Cool/monitor/view/ResizeHandleConversion.md`
