# Task: Convert `monitor/view/MultiScreenToolBar.qml` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/monitor/view/MultiScreenToolBar.qml` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/monitor/view/MultiScreenToolBar.qml`
...
## Output
- `src/Cool/monitor/view/MultiScreenToolBarConversion.md`
