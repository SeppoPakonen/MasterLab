# Task: Convert `assets/view/widgets/switchparamwidget.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/view/widgets/switchparamwidget.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/view/widgets/switchparamwidget.cpp`
...
## Output
- `src/Cool/assets/view/widgets/Switchparamwidget.cpp`
