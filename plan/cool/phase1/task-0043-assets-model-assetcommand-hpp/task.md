# Task: Convert `assets/model/assetcommand.hpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/model/assetcommand.hpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/model/assetcommand.hpp`
...
## Output
- `src/Cool/assets/model/Assetcommand.hpp`
