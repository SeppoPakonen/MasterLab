# Task: Convert `titler/graphicsscenerectmove.h` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/titler/graphicsscenerectmove.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/titler/graphicsscenerectmove.h`
...
## Output
- `src/Cool/titler/Graphicsscenerectmove.h`
