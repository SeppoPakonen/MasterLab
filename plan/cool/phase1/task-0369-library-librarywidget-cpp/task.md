# Task: Convert `library/librarywidget.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/library/librarywidget.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/library/librarywidget.cpp`
...
## Output
- `src/Cool/library/Librarywidget.cpp`
