# Task: Convert `bin/mediabrowser.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/bin/mediabrowser.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/bin/mediabrowser.cpp`
