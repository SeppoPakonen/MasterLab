# Task: Convert `bin/CMakeLists.txt` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/bin/CMakeLists.txt` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/bin/CMakeLists.txt`
...
## Output
- `src/Cool/bin/CMakeListsConversion.md`
