# Task: Convert `effects/effectstack/model/effectstackfilter.hpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/effects/effectstack/model/effectstackfilter.hpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/effects/effectstack/model/effectstackfilter.hpp`
...
## Output
- `src/Cool/effects/effectstack/model/Effectstackfilter.hpp`
