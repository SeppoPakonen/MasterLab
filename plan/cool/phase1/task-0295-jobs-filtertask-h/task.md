# Task: Convert `jobs/filtertask.h` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/jobs/filtertask.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/jobs/filtertask.h`
