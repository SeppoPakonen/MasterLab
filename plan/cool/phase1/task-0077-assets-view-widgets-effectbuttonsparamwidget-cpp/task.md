# Task: Convert `assets/view/widgets/effectbuttonsparamwidget.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/view/widgets/effectbuttonsparamwidget.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/view/widgets/effectbuttonsparamwidget.cpp`
...
## Output
- `src/Cool/assets/view/widgets/Effectbuttonsparamwidget.cpp`
