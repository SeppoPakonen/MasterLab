# Task: Convert `effects/effectstack/view/maskmanager.hpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/effects/effectstack/view/maskmanager.hpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/effects/effectstack/view/maskmanager.hpp`
...
## Output
- `src/Cool/effects/effectstack/view/Maskmanager.hpp`
