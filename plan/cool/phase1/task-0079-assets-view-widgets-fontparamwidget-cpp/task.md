# Task: Convert `assets/view/widgets/fontparamwidget.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/view/widgets/fontparamwidget.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/view/widgets/fontparamwidget.cpp`
...
## Output
- `src/Cool/assets/view/widgets/Fontparamwidget.cpp`
