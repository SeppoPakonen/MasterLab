# Task: Convert `lib/audio/audioInfo.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/lib/audio/audioInfo.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/lib/audio/audioInfo.cpp`
...
## Output
- `src/Cool/lib/audio/AudioInfo.cpp`
