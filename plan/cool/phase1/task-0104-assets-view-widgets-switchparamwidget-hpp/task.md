# Task: Convert `assets/view/widgets/switchparamwidget.hpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/view/widgets/switchparamwidget.hpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/view/widgets/switchparamwidget.hpp`
...
## Output
- `src/Cool/assets/view/widgets/Switchparamwidget.hpp`
