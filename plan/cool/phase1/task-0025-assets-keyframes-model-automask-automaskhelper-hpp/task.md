# Task: Convert `assets/keyframes/model/automask/automaskhelper.hpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/keyframes/model/automask/automaskhelper.hpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/keyframes/model/automask/automaskhelper.hpp`
...
## Output
- `src/Cool/assets/keyframes/model/automask/Automaskhelper.hpp`
