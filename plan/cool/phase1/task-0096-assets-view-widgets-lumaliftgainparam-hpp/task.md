# Task: Convert `assets/view/widgets/lumaliftgainparam.hpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/view/widgets/lumaliftgainparam.hpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/view/widgets/lumaliftgainparam.hpp`
...
## Output
- `src/Cool/assets/view/widgets/Lumaliftgainparam.hpp`
