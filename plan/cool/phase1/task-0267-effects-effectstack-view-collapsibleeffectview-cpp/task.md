# Task: Convert `effects/effectstack/view/collapsibleeffectview.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/effects/effectstack/view/collapsibleeffectview.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/effects/effectstack/view/collapsibleeffectview.cpp`
...
## Output
- `src/Cool/effects/effectstack/view/Collapsibleeffectview.cpp`
