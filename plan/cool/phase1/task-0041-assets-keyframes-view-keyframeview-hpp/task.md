# Task: Convert `assets/keyframes/view/keyframeview.hpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/keyframes/view/keyframeview.hpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/keyframes/view/keyframeview.hpp`
...
## Output
- `src/Cool/assets/keyframes/view/Keyframeview.hpp`
