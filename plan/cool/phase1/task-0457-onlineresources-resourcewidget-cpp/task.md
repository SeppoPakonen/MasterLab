# Task: Convert `onlineresources/resourcewidget.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/onlineresources/resourcewidget.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/onlineresources/resourcewidget.cpp`
...
## Output
- `src/Cool/onlineresources/Resourcewidget.cpp`
