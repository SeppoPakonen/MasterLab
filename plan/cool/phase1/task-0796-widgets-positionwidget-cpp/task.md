# Task: Convert `widgets/positionwidget.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/widgets/positionwidget.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/widgets/positionwidget.cpp`
...
## Output
- `src/Cool/widgets/Positionwidget.cpp`
