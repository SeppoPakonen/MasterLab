# Task: Convert `project/effectsettings.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/project/effectsettings.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/project/effectsettings.cpp`
...
## Output
- `src/Cool/project/Effectsettings.cpp`
