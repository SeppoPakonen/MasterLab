# Task: Convert `monitor/view/MonitorCornerScene.qml` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/monitor/view/MonitorCornerScene.qml` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/monitor/view/MonitorCornerScene.qml`
...
## Output
- `src/Cool/monitor/view/MonitorCornerSceneConversion.md`
