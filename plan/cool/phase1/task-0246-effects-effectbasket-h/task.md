# Task: Convert `effects/effectbasket.h` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/effects/effectbasket.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/effects/effectbasket.h`
...
## Output
- `src/Cool/effects/Effectbasket.h`
