# Task: Convert `widgets/dragvalue.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/widgets/dragvalue.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/widgets/dragvalue.cpp`
...
## Output
- `src/Cool/widgets/Dragvalue.cpp`
