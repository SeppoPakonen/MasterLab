# Task: Convert `monitor/videowidget.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/monitor/videowidget.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/monitor/videowidget.cpp`
...
## Output
- `src/Cool/monitor/Videowidget.cpp`
