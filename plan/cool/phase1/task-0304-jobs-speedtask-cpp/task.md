# Task: Convert `jobs/speedtask.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/jobs/speedtask.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/jobs/speedtask.cpp`
