# Task: Convert `titler/titledocument.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/titler/titledocument.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/titler/titledocument.cpp`
...
## Output
- `src/Cool/titler/Titledocument.cpp`
