# Task: Convert `jobs/audiolevels/generators.h` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/jobs/audiolevels/generators.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/jobs/audiolevels/generators.h`
...
## Output
- `src/Cool/jobs/audiolevels/Generators.h`
