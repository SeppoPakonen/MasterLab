# Task: Convert `monitor/view/SceneToolBar.qml` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/monitor/view/SceneToolBar.qml` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/monitor/view/SceneToolBar.qml`
...
## Output
- `src/Cool/monitor/view/SceneToolBarConversion.md`
