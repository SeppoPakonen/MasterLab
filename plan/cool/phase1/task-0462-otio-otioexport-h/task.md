# Task: Convert `otio/otioexport.h` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/otio/otioexport.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/otio/otioexport.h`
