# Task: Convert `assets/view/widgets/keyframecontainer.hpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/view/widgets/keyframecontainer.hpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/view/widgets/keyframecontainer.hpp`
...
## Output
- `src/Cool/assets/view/widgets/Keyframecontainer.hpp`
