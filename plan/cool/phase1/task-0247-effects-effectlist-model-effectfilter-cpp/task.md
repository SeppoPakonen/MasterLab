# Task: Convert `effects/effectlist/model/effectfilter.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/effects/effectlist/model/effectfilter.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/effects/effectlist/model/effectfilter.cpp`
...
## Output
- `src/Cool/effects/effectlist/model/Effectfilter.cpp`
