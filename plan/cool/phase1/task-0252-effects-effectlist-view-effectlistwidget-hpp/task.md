# Task: Convert `effects/effectlist/view/effectlistwidget.hpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/effects/effectlist/view/effectlistwidget.hpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/effects/effectlist/view/effectlistwidget.hpp`
...
## Output
- `src/Cool/effects/effectlist/view/Effectlistwidget.hpp`
