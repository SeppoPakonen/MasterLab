# Task: Convert `assets/view/widgets/fontparamwidget.hpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/view/widgets/fontparamwidget.hpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/view/widgets/fontparamwidget.hpp`
...
## Output
- `src/Cool/assets/view/widgets/Fontparamwidget.hpp`
