# Task: Convert `effects/effectstack/model/abstracteffectitem.hpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/effects/effectstack/model/abstracteffectitem.hpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/effects/effectstack/model/abstracteffectitem.hpp`
...
## Output
- `src/Cool/effects/effectstack/model/Abstracteffectitem.hpp`
