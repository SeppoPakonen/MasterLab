# Task: Convert `qml/ZoomBar.qml` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/qml/ZoomBar.qml` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/qml/ZoomBar.qml`
...
## Output
- `src/Cool/qml/ZoomBarConversion.md`
