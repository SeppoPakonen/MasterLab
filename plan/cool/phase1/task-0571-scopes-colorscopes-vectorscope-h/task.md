# Task: Convert `scopes/colorscopes/vectorscope.h` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/scopes/colorscopes/vectorscope.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/scopes/colorscopes/vectorscope.h`
...
## Output
- `src/Cool/scopes/colorscopes/Vectorscope.h`
