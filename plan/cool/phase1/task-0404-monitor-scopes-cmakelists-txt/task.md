# Task: Convert `monitor/scopes/CMakeLists.txt` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/monitor/scopes/CMakeLists.txt` and convert it into MasterLab U++ conventions without attempting to compile.
