# Task: Convert `effects/effectstack/view/collapsibleeffectview.hpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/effects/effectstack/view/collapsibleeffectview.hpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/effects/effectstack/view/collapsibleeffectview.hpp`
...
## Output
- `src/Cool/effects/effectstack/view/Collapsibleeffectview.hpp`
