# Task: Convert `timeline2/model/snapmodel.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/timeline2/model/snapmodel.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/timeline2/model/snapmodel.cpp`
...
## Output
- `src/Cool/timeline2/model/Snapmodel.cpp`
