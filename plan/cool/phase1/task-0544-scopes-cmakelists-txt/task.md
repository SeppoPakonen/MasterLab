# Task: Convert `scopes/CMakeLists.txt` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/scopes/CMakeLists.txt` and convert it into MasterLab U++ conventions without attempting to compile.
