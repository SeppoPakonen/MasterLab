# Task: Convert `lib/audio/audioStreamInfo.h` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/lib/audio/audioStreamInfo.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/lib/audio/audioStreamInfo.h`
...
## Output
- `src/Cool/lib/audio/AudioStreamInfo.h`
