# Task: Convert `monitor/view/OverlayCenterDiagonal.qml` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/monitor/view/OverlayCenterDiagonal.qml` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/monitor/view/OverlayCenterDiagonal.qml`
...
## Output
- `src/Cool/monitor/view/OverlayCenterDiagonalConversion.md`
