# Task: Convert `effects/effectstack/view/maskmanager.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/effects/effectstack/view/maskmanager.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/effects/effectstack/view/maskmanager.cpp`
...
## Output
- `src/Cool/effects/effectstack/view/Maskmanager.cpp`
