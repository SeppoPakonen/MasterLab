# Task: Convert `assets/keyframes/model/rect/recthelper.hpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/keyframes/model/rect/recthelper.hpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/keyframes/model/rect/recthelper.hpp`
...
## Output
- `src/Cool/assets/keyframes/model/rect/Recthelper.hpp`
