# Task: Convert `timeline2/view/qml/Ruler.qml` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/timeline2/view/qml/Ruler.qml` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/timeline2/view/qml/Ruler.qml`
...
## Output
- `src/Cool/timeline2/view/qml/RulerConversion.md`
