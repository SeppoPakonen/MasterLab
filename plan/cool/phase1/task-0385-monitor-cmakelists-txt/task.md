# Task: Convert `monitor/CMakeLists.txt` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/monitor/CMakeLists.txt` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/monitor/CMakeLists.txt`
...
## Output
- `src/Cool/monitor/CMakeListsConversion.md`
