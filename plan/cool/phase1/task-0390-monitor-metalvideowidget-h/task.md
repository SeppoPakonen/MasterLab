# Task: Convert `monitor/metalvideowidget.h` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/monitor/metalvideowidget.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/monitor/metalvideowidget.h`
...
## Output
- `src/Cool/monitor/Metalvideowidget.h`
