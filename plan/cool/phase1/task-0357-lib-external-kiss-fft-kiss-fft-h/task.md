# Task: Convert `lib/external/kiss_fft/kiss_fft.h` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/lib/external/kiss_fft/kiss_fft.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/lib/external/kiss_fft/kiss_fft.h`
...
## Output
- `src/Cool/lib/external/kiss_fft/KissFft.h`
