# Task: Convert `assets/view/widgets/multiswitchparamwidget.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/view/widgets/multiswitchparamwidget.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/view/widgets/multiswitchparamwidget.cpp`
...
## Output
- `src/Cool/assets/view/widgets/Multiswitchparamwidget.cpp`
