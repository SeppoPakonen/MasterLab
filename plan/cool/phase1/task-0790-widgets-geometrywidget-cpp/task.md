# Task: Convert `widgets/geometrywidget.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/widgets/geometrywidget.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/widgets/geometrywidget.cpp`
...
## Output
- `src/Cool/widgets/Geometrywidget.cpp`
