# Task: Convert `assets/keyframes/model/keyframemodel.hpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/keyframes/model/keyframemodel.hpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/keyframes/model/keyframemodel.hpp`
...
## Output
- `src/Cool/assets/keyframes/model/Keyframemodel.hpp`
