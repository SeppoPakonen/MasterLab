# Task: Convert `monitor/view/EffectToolBar.qml` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/monitor/view/EffectToolBar.qml` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/monitor/view/EffectToolBar.qml`
...
## Output
- `src/Cool/monitor/view/EffectToolBarConversion.md`
