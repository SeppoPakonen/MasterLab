# Task: Convert `audiomixer/audiolevels/audioleveltypes.h` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/audiomixer/audiolevels/audioleveltypes.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/audiomixer/audiolevels/audioleveltypes.h`
...
## Output
- `src/Cool/audiomixer/audiolevels/Audioleveltypes.h`
