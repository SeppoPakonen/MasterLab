# Task: Convert `assets/view/widgets/doubleparamwidget.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/view/widgets/doubleparamwidget.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/view/widgets/doubleparamwidget.cpp`
...
## Output
- `src/Cool/assets/view/widgets/Doubleparamwidget.cpp`
