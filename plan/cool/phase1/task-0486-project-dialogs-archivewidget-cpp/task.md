# Task: Convert `project/dialogs/archivewidget.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/project/dialogs/archivewidget.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/project/dialogs/archivewidget.cpp`
...
## Output
- `src/Cool/project/dialogs/Archivewidget.cpp`
