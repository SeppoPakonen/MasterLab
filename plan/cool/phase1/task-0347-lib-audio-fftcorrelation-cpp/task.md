# Task: Convert `lib/audio/fftCorrelation.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/lib/audio/fftCorrelation.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/lib/audio/fftCorrelation.cpp`
...
## Output
- `src/Cool/lib/audio/FftCorrelation.cpp`
