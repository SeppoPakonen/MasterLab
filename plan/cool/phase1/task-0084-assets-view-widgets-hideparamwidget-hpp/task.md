# Task: Convert `assets/view/widgets/hideparamwidget.hpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/view/widgets/hideparamwidget.hpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/view/widgets/hideparamwidget.hpp`
...
## Output
- `src/Cool/assets/view/widgets/Hideparamwidget.hpp`
