# Task: Convert `monitor/view/MaskToolBar.qml` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/monitor/view/MaskToolBar.qml` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/monitor/view/MaskToolBar.qml`
...
## Output
- `src/Cool/monitor/view/MaskToolBarConversion.md`
