# Task: Convert `jogshuttle/jogaction.h` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/jogshuttle/jogaction.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/jogshuttle/jogaction.h`
...
## Output
- `src/Cool/jogshuttle/Jogaction.h`
