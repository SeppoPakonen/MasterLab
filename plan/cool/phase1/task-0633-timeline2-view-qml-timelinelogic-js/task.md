# Task: Convert `timeline2/view/qml/TimelineLogic.js` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/timeline2/view/qml/TimelineLogic.js` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/timeline2/view/qml/TimelineLogic.js`
...
## Output
- `src/Cool/timeline2/view/qml/TimelineLogicConversion.md`
