# Task: Convert `lib/audio/audioCorrelationInfo.h` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/lib/audio/audioCorrelationInfo.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/lib/audio/audioCorrelationInfo.h`
...
## Output
- `src/Cool/lib/audio/AudioCorrelationInfo.h`
