# Task: Convert `jobs/CMakeLists.txt` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/jobs/CMakeLists.txt` and convert it into MasterLab U++ conventions without attempting to compile.
