# Task: Convert `abstractmodel/abstracttreemodel.hpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/abstractmodel/abstracttreemodel.hpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/abstractmodel/abstracttreemodel.hpp`
...
## Output
- `src/Cool/abstractmodel/Abstracttreemodel.hpp`
