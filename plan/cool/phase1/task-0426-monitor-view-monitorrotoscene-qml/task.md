# Task: Convert `monitor/view/MonitorRotoScene.qml` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/monitor/view/MonitorRotoScene.qml` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/monitor/view/MonitorRotoScene.qml`
...
## Output
- `src/Cool/monitor/view/MonitorRotoSceneConversion.md`
