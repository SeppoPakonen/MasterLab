# Task: Convert `dialogs/Splash.qml` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/dialogs/Splash.qml` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/dialogs/Splash.qml`
...
## Output
- `src/Cool/dialogs/SplashConversion.md`
