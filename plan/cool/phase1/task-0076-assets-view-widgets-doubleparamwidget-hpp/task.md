# Task: Convert `assets/view/widgets/doubleparamwidget.hpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/view/widgets/doubleparamwidget.hpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/view/widgets/doubleparamwidget.hpp`
...
## Output
- `src/Cool/assets/view/widgets/Doubleparamwidget.hpp`
