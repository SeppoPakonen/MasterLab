# Task: Convert `dialogs/wizard.h` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/dialogs/wizard.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/dialogs/wizard.h`
