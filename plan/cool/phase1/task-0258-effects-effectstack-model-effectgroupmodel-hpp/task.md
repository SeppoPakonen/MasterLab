# Task: Convert `effects/effectstack/model/effectgroupmodel.hpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/effects/effectstack/model/effectgroupmodel.hpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/effects/effectstack/model/effectgroupmodel.hpp`
...
## Output
- `src/Cool/effects/effectstack/model/Effectgroupmodel.hpp`
