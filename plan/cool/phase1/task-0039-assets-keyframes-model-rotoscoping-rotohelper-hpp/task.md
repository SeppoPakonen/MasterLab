# Task: Convert `assets/keyframes/model/rotoscoping/rotohelper.hpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/keyframes/model/rotoscoping/rotohelper.hpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/keyframes/model/rotoscoping/rotohelper.hpp`
...
## Output
- `src/Cool/assets/keyframes/model/rotoscoping/Rotohelper.hpp`
