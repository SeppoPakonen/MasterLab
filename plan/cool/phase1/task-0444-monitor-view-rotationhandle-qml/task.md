# Task: Convert `monitor/view/RotationHandle.qml` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/monitor/view/RotationHandle.qml` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/monitor/view/RotationHandle.qml`
...
## Output
- `src/Cool/monitor/view/RotationHandleConversion.md`
