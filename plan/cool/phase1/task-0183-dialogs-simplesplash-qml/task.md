# Task: Convert `dialogs/Simplesplash.qml` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/dialogs/Simplesplash.qml` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/dialogs/Simplesplash.qml`
...
## Output
- `src/Cool/dialogs/SimplesplashConversion.md`
