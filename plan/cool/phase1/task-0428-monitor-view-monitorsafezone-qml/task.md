# Task: Convert `monitor/view/MonitorSafeZone.qml` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/monitor/view/MonitorSafeZone.qml` and convert it into MasterLab U++ conventions without attempting to compile.
