# Task: Convert `bin/generators/generators.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/bin/generators/generators.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/bin/generators/generators.cpp`
...
## Output
- `src/Cool/bin/generators/Generators.cpp`
