# Task: Convert `jobs/audiolevels/generators.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/jobs/audiolevels/generators.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/jobs/audiolevels/generators.cpp`
...
## Output
- `src/Cool/jobs/audiolevels/Generators.cpp`
