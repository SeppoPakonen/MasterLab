# Task: Convert `lib/audio/fftTools.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/lib/audio/fftTools.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/lib/audio/fftTools.cpp`
...
## Output
- `src/Cool/lib/audio/FftTools.cpp`
