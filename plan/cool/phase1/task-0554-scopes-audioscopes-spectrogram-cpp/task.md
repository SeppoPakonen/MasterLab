# Task: Convert `scopes/audioscopes/spectrogram.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/scopes/audioscopes/spectrogram.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/scopes/audioscopes/spectrogram.cpp`
...
## Output
- `src/Cool/scopes/audioscopes/Spectrogram.cpp`
