# Task: Convert `assets/view/widgets/buttonparamwidget.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/view/widgets/buttonparamwidget.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/view/widgets/buttonparamwidget.cpp`
...
## Output
- `src/Cool/assets/view/widgets/Buttonparamwidget.cpp`
