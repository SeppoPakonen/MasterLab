# Task: Convert `scopes/colorscopes/colorplaneexport.h` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/scopes/colorscopes/colorplaneexport.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/scopes/colorscopes/colorplaneexport.h`
...
## Output
- `src/Cool/scopes/colorscopes/Colorplaneexport.h`
