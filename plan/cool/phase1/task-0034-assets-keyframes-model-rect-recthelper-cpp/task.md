# Task: Convert `assets/keyframes/model/rect/recthelper.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/keyframes/model/rect/recthelper.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/keyframes/model/rect/recthelper.cpp`
...
## Output
- `src/Cool/assets/keyframes/model/rect/Recthelper.cpp`
