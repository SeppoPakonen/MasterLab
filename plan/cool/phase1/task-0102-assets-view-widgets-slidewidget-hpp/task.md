# Task: Convert `assets/view/widgets/slidewidget.hpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/view/widgets/slidewidget.hpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/view/widgets/slidewidget.hpp`
...
## Output
- `src/Cool/assets/view/widgets/Slidewidget.hpp`
