# Task: Convert `assets/view/widgets/hideparamwidget.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/view/widgets/hideparamwidget.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/view/widgets/hideparamwidget.cpp`
...
## Output
- `src/Cool/assets/view/widgets/Hideparamwidget.cpp`
