# Task: Convert `jobs/abstracttask.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/jobs/abstracttask.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/jobs/abstracttask.cpp`
...
## Output
- `src/Cool/jobs/Abstracttask.cpp`
