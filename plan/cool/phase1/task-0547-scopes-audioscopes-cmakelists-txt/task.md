# Task: Convert `scopes/audioscopes/CMakeLists.txt` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/scopes/audioscopes/CMakeLists.txt` and convert it into MasterLab U++ conventions without attempting to compile.
