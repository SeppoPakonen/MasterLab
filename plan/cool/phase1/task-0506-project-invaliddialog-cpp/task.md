# Task: Convert `project/invaliddialog.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/project/invaliddialog.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/project/invaliddialog.cpp`
...
## Output
- `src/Cool/project/Invaliddialog.cpp`
