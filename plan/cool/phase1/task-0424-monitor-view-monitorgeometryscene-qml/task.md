# Task: Convert `monitor/view/MonitorGeometryScene.qml` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/monitor/view/MonitorGeometryScene.qml` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/monitor/view/MonitorGeometryScene.qml`
...
## Output
- `src/Cool/monitor/view/MonitorGeometrySceneConversion.md`
