# Task: Convert `monitor/view/OverlayStandard.qml` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/monitor/view/OverlayStandard.qml` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/monitor/view/OverlayStandard.qml`
...
## Output
- `src/Cool/monitor/view/OverlayStandardConversion.md`
