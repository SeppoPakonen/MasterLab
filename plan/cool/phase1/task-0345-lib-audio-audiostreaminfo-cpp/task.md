# Task: Convert `lib/audio/audioStreamInfo.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/lib/audio/audioStreamInfo.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/lib/audio/audioStreamInfo.cpp`
...
## Output
- `src/Cool/lib/audio/AudioStreamInfo.cpp`
