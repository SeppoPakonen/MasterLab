# Task: Convert `profiles/profileinfo.hpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/profiles/profileinfo.hpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/profiles/profileinfo.hpp`
...
## Output
- `src/Cool/profiles/Profileinfo.hpp`
