# Task: Convert `widgets/doublewidget.h` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/widgets/doublewidget.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/widgets/doublewidget.h`
...
## Output
- `src/Cool/widgets/Doublewidget.h`
