# Task: Convert `jobs/scenesplittask.h` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/jobs/scenesplittask.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/jobs/scenesplittask.h`
...
## Output
- `src/Cool/jobs/Scenesplittask.h`
