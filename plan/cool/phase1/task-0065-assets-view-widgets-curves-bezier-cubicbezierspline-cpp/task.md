# Task: Convert `assets/view/widgets/curves/bezier/cubicbezierspline.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/view/widgets/curves/bezier/cubicbezierspline.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/view/widgets/curves/bezier/cubicbezierspline.cpp`
...
## Output
- `src/Cool/assets/view/widgets/curves/bezier/Cubicbezierspline.cpp`
