# Task: Convert `lib/external/CMakeLists.txt` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/lib/external/CMakeLists.txt` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/lib/external/CMakeLists.txt`
...
## Output
- `src/Cool/lib/external/CMakeListsConversion.md`
