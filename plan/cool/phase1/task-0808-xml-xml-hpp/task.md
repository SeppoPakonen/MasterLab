# Task: Convert `xml/xml.hpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/xml/xml.hpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/xml/xml.hpp`
