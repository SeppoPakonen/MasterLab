# Task: Convert `jobs/customjobtask.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/jobs/customjobtask.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/jobs/customjobtask.cpp`
...
## Output
- `src/Cool/jobs/Customjobtask.cpp`
