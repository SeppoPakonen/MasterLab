# Task: Convert `utils/uiutils.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/utils/uiutils.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/utils/uiutils.cpp`
