# Task: Convert `lib/audio/audioInfo.h` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/lib/audio/audioInfo.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/lib/audio/audioInfo.h`
...
## Output
- `src/Cool/lib/audio/AudioInfo.h`
