# Task: Convert `capture/mediacapture.h` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/capture/mediacapture.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/capture/mediacapture.h`
...
## Output
- `src/Cool/capture/Mediacapture.h`
