# Task: Convert `assets/keyframes/model/corners/cornershelper.hpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/keyframes/model/corners/cornershelper.hpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/keyframes/model/corners/cornershelper.hpp`
...
## Output
- `src/Cool/assets/keyframes/model/corners/Cornershelper.hpp`
