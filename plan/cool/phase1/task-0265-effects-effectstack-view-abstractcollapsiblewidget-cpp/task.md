# Task: Convert `effects/effectstack/view/abstractcollapsiblewidget.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/effects/effectstack/view/abstractcollapsiblewidget.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/effects/effectstack/view/abstractcollapsiblewidget.cpp`
...
## Output
- `src/Cool/effects/effectstack/view/Abstractcollapsiblewidget.cpp`
