# Task: Convert `assets/view/widgets/curves/bezier/cubicbezierspline.h` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/view/widgets/curves/bezier/cubicbezierspline.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/view/widgets/curves/bezier/cubicbezierspline.h`
...
## Output
- `src/Cool/assets/view/widgets/curves/bezier/Cubicbezierspline.h`
