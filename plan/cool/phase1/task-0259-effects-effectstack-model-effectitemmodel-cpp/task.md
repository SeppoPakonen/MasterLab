# Task: Convert `effects/effectstack/model/effectitemmodel.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/effects/effectstack/model/effectitemmodel.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/effects/effectstack/model/effectitemmodel.cpp`
...
## Output
- `src/Cool/effects/effectstack/model/Effectitemmodel.cpp`
