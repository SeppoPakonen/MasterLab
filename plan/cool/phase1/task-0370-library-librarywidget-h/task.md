# Task: Convert `library/librarywidget.h` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/library/librarywidget.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/library/librarywidget.h`
...
## Output
- `src/Cool/library/Librarywidget.h`
