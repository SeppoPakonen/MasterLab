# Task: Convert `assets/view/widgets/abstractparamwidget.hpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/view/widgets/abstractparamwidget.hpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/view/widgets/abstractparamwidget.hpp`
...
## Output
- `src/Cool/assets/view/widgets/Abstractparamwidget.hpp`
