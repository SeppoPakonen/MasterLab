# Task: Convert `project/clipstabilize.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/project/clipstabilize.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/project/clipstabilize.cpp`
...
## Output
- `src/Cool/project/Clipstabilize.cpp`
