# Task: Convert `project/dialogs/noteswidget.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/project/dialogs/noteswidget.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/project/dialogs/noteswidget.cpp`
...
## Output
- `src/Cool/project/dialogs/Noteswidget.cpp`
