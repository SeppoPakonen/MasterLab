# Task: Convert `effects/effectlist/model/effectfilter.hpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/effects/effectlist/model/effectfilter.hpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/effects/effectlist/model/effectfilter.hpp`
...
## Output
- `src/Cool/effects/effectlist/model/Effectfilter.hpp`
