# Task: Convert `bin/projectfolder.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/bin/projectfolder.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/bin/projectfolder.cpp`
...
## Output
- `src/Cool/bin/Projectfolder.cpp`
