# Task: Convert `assets/keyframes/model/corners/cornershelper.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/keyframes/model/corners/cornershelper.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/keyframes/model/corners/cornershelper.cpp`
...
## Output
- `src/Cool/assets/keyframes/model/corners/Cornershelper.cpp`
