# Task: Convert `lib/external/kiss_fft/README.md.license` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/lib/external/kiss_fft/README.md.license` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/lib/external/kiss_fft/README.md.license`
...
## Output
- `src/Cool/lib/external/kiss_fft/READMEMdConversion.md`
