# Task: Convert `monitor/view/MonitorSplitTracks.qml` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/monitor/view/MonitorSplitTracks.qml` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/monitor/view/MonitorSplitTracks.qml`
...
## Output
- `src/Cool/monitor/view/MonitorSplitTracksConversion.md`
