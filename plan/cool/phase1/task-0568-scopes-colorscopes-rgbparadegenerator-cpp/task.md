# Task: Convert `scopes/colorscopes/rgbparadegenerator.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/scopes/colorscopes/rgbparadegenerator.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/scopes/colorscopes/rgbparadegenerator.cpp`
...
## Output
- `src/Cool/scopes/colorscopes/Rgbparadegenerator.cpp`
