# Task: Convert `assets/view/widgets/buttonparamwidget.hpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/view/widgets/buttonparamwidget.hpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/view/widgets/buttonparamwidget.hpp`
...
## Output
- `src/Cool/assets/view/widgets/Buttonparamwidget.hpp`
