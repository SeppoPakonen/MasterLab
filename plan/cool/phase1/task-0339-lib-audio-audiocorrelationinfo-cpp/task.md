# Task: Convert `lib/audio/audioCorrelationInfo.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/lib/audio/audioCorrelationInfo.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/lib/audio/audioCorrelationInfo.cpp`
...
## Output
- `src/Cool/lib/audio/AudioCorrelationInfo.cpp`
