# Task: Convert `lib/localeHandling.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/lib/localeHandling.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/lib/localeHandling.cpp`
...
## Output
- `src/Cool/lib/LocaleHandling.cpp`
