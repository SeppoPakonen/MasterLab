# Task: Convert `timeline2/view/qml/Composition.qml` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/timeline2/view/qml/Composition.qml` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/timeline2/view/qml/Composition.qml`
...
## Output
- `src/Cool/timeline2/view/qml/CompositionConversion.md`
