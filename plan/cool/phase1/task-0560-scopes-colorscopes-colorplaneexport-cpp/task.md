# Task: Convert `scopes/colorscopes/colorplaneexport.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/scopes/colorscopes/colorplaneexport.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/scopes/colorscopes/colorplaneexport.cpp`
...
## Output
- `src/Cool/scopes/colorscopes/Colorplaneexport.cpp`
