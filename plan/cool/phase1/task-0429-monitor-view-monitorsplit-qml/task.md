# Task: Convert `monitor/view/MonitorSplit.qml` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/monitor/view/MonitorSplit.qml` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/monitor/view/MonitorSplit.qml`
...
## Output
- `src/Cool/monitor/view/MonitorSplitConversion.md`
