# Task: Convert `assets/view/widgets/abstractparamwidget.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/view/widgets/abstractparamwidget.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/view/widgets/abstractparamwidget.cpp`
...
## Output
- `src/Cool/assets/view/widgets/Abstractparamwidget.cpp`
