# Task: Convert `timeline2/model/moveableItem.ipp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/timeline2/model/moveableItem.ipp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/timeline2/model/moveableItem.ipp`
...
## Output
- `src/Cool/timeline2/model/MoveableItem.ipp`
