# Task: Convert `lib/external/kiss_fft/CMakeLists.txt` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/lib/external/kiss_fft/CMakeLists.txt` and convert it into MasterLab U++ conventions without attempting to compile.
