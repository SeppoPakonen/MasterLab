# Task: Convert `jobs/melttask.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/jobs/melttask.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/jobs/melttask.cpp`
