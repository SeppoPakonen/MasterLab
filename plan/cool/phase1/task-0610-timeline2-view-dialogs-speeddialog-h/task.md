# Task: Convert `timeline2/view/dialogs/speeddialog.h` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/timeline2/view/dialogs/speeddialog.h` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/timeline2/view/dialogs/speeddialog.h`
...
## Output
- `src/Cool/timeline2/view/dialogs/Speeddialog.h`
