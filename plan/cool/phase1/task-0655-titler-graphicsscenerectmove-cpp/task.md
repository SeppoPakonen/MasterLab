# Task: Convert `titler/graphicsscenerectmove.cpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/titler/graphicsscenerectmove.cpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/titler/graphicsscenerectmove.cpp`
...
## Output
- `src/Cool/titler/Graphicsscenerectmove.cpp`
