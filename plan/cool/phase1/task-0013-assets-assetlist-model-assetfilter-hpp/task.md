# Task: Convert `assets/assetlist/model/assetfilter.hpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/assetlist/model/assetfilter.hpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/assetlist/model/assetfilter.hpp`
...
## Output
- `src/Cool/assets/assetlist/model/Assetfilter.hpp`
