# Task: Convert `assets/view/widgets/clickablelabelwidget.hpp` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/assets/view/widgets/clickablelabelwidget.hpp` and convert it into MasterLab U++ conventions without attempting to compile.

## Source
- `tmp/k/src/assets/view/widgets/clickablelabelwidget.hpp`
...
## Output
- `src/Cool/assets/view/widgets/Clickablelabelwidget.hpp`
