# Task: Convert `scopes/colorscopes/CMakeLists.txt` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/scopes/colorscopes/CMakeLists.txt` and convert it into MasterLab U++ conventions without attempting to compile.
