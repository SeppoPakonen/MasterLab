# Task: Convert `xml/CMakeLists.txt` to U++
# Status: DONE

## Objective
Manually read `tmp/k/src/xml/CMakeLists.txt` and convert it into MasterLab U++ conventions without attempting to compile.
